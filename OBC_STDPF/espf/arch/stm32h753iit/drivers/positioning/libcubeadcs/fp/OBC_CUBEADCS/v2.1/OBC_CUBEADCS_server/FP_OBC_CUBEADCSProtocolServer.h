...
#ifndef FP_OBC_CUBEADCSPROTOCOLSERVER_H
#define FP_OBC_CUBEADCSPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
#define OBC_CUBEADCS_PROTOCOL_VERSION_MAJOR   ((uint8_t) 2)
...
typedef void (*pfOBC_CUBEADCS_setCommissioningStatusRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsetCommissioningStatusRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_getGenericTLMRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSgetGenericTLMRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_sendGenericTCRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsendGenericTCRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_getOpStatusRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_resetRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSresetRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_clrErrFlagsRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_startFileTransferRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSstartFileTransferRequestData_t *pRequestData);
...
typedef void (*pfOBC_CUBEADCS_setADCSSysStateRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsetADCSSysStateRequestData_t *pRequestData);
...
typedef void (*pfOBC_CUBEADCS_setEnableErrHandlLogicRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsetEnableErrHandlLogicRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_getEnableErrHandlLogicRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_setStablePointingThresholdsRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsetStablePointingThresholdsRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_getStablePointingThresholdsRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_setSimulationModeRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsetSimulationModeRequestData_t *pRequestData);
...
typedef void (*pfOBC_CUBEADCS_clrOBCCommAndErrCountersRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSclrOBCCommAndErrCountersRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_getFDIRCounersRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_clrFDIRCountersRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSclrFDIRCountersRequestData_t *pRequestData);
...
typedef void (*pfOBC_CUBEADCS_setSystemStateCfgRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCSsetSystemStateCfgRequestData_t *pRequestData);
...
#endif  // #ifndef FP_OBC_CUBEADCSPROTOCOLSERVER_H
