...
{
  .OBC_CUBEADCS_getCommissioningStatusRequestHandler = OBC_CUBEADCS_getCommissioningStatusRequestHandlerImpl,
  .OBC_CUBEADCS_setCommissioningStatusRequestHandler = OBC_CUBEADCS_setCommissioningStatusRequestHandlerImpl,
  .OBC_CUBEADCS_getGenericTLMRequestHandler = OBC_CUBEADCS_getGenericTLMRequestHandlerImpl,
  .OBC_CUBEADCS_sendGenericTCRequestHandler = OBC_CUBEADCS_sendGenericTCRequestHandlerImpl,
  .OBC_CUBEADCS_getOpStatusRequestHandler = OBC_CUBEADCS_getOpStatusRequestHandlerImpl,
  .OBC_CUBEADCS_resetRequestHandler = OBC_CUBEADCS_resetRequestHandlerImpl,
  .OBC_CUBEADCS_clrErrFlagsRequestHandler = OBC_CUBEADCS_clrErrFlagsRequestHandlerImpl,
  .OBC_CUBEADCS_startFileTransferRequestHandler = OBC_CUBEADCS_startFileTransferRequestHandlerImpl,
  .OBC_CUBEADCS_pollFileTransferStatusRequestHandler = OBC_CUBEADCS_pollFileTransferStatusRequestHandlerImpl,
  .OBC_CUBEADCS_clearRunTimeLatchedErrsRequestHandler = OBC_CUBEADCS_clearRunTimeLatchedErrsRequestHandlerImpl,
  .OBC_CUBEADCS_clearFaultyNodeStatusRequestHandler = OBC_CUBEADCS_clearFaultyNodeStatusRequestHandlerImpl,
  .OBC_CUBEADCS_startFileListDownloadRequestHandler = OBC_CUBEADCS_startFileListDownloadRequestHandlerImpl,
  .OBC_CUBEADCS_pollFileListDownloadStatusRequestHandler = OBC_CUBEADCS_pollFileListDownloadStatusRequestHandlerImpl,
  .OBC_CUBEADCS_getADCSSysStateRequestHandler = OBC_CUBEADCS_getADCSSysStateRequestHandlerImpl,
  .OBC_CUBEADCS_setADCSSysStateRequestHandler = OBC_CUBEADCS_setADCSSysStateRequestHandlerImpl,
  .OBC_CUBEADCS_getADCSUnixTimeRequestHandler = OBC_CUBEADCS_getADCSUnixTimeRequestHandlerImpl,
  .OBC_CUBEADCS_updateADCSUnixTimeRequestHandler = OBC_CUBEADCS_updateADCSUnixTimeRequestHandlerImpl,
  .OBC_CUBEADCS_setEnableErrHandlLogicRequestHandler = OBC_CUBEADCS_setEnableErrHandlLogicRequestHandlerImpl,
  .OBC_CUBEADCS_getEnableErrHandlLogicRequestHandler = OBC_CUBEADCS_getEnableErrHandlLogicRequestHandlerImpl,
  .OBC_CUBEADCS_setStablePointingThresholdsRequestHandler = OBC_CUBEADCS_setStablePointingThresholdsRequestHandlerImpl,
  .OBC_CUBEADCS_getStablePointingThresholdsRequestHandler = OBC_CUBEADCS_getStablePointingThresholdsRequestHandlerImpl,
  .OBC_CUBEADCS_setSimulationModeRequestHandler = OBC_CUBEADCS_setSimulationModeRequestHandlerImpl,
  .OBC_CUBEADCS_getSimulationModeValueRequestHandler = OBC_CUBEADCS_getSimulationModeValueRequestHandlerImpl,
  .OBC_CUBEADCS_getOBCCommAndErrCountersRequestHandler = OBC_CUBEADCS_getOBCCommAndErrCountersRequestHandlerImpl,
  .OBC_CUBEADCS_clrOBCCommAndErrCountersRequestHandler = OBC_CUBEADCS_clrOBCCommAndErrCountersRequestHandlerImpl,
  .OBC_CUBEADCS_getFDIRCounersRequestHandler = OBC_CUBEADCS_getFDIRCounersRequestHandlerImpl,
  .OBC_CUBEADCS_clrFDIRCountersRequestHandler = OBC_CUBEADCS_clrFDIRCountersRequestHandlerImpl,
  .OBC_CUBEADCS_stopFileTransferRequestHandler = OBC_CUBEADCS_stopFileTransferRequestHandlerImpl,
  .OBC_CUBEADCS_getRunTimeLatchedErrsRequestHandler = OBC_CUBEADCS_getRunTimeLatchedErrsRequestHandlerImpl,
  .OBC_CUBEADCS_getFaultyNodeStatusRequestHandler = OBC_CUBEADCS_getFaultyNodeStatusRequestHandlerImpl,
  .OBC_CUBEADCS_setSystemStateCfgRequestHandler = OBC_CUBEADCS_setSystemStateCfgRequestHandlerImpl,
  .OBC_CUBEADCS_getSystemStateCfgRequestHandler = OBC_CUBEADCS_getSystemStateCfgRequestHandlerImpl
};
...
static void OBC_CUBEADCS_getCommissioningStatusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        if(sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS))
        {
            ...
            switch (resStatus)
            {
                case eCUBEADCS_NOT_DONE:
                    eStatus = OBC_CUBEADCS_COMMISSIONINGSTATUS_NOT_DONE;
                break;

                case eCUBEADCS_COMPLETE:
                    eStatus = OBC_CUBEADCS_COMMISSIONINGSTATUS_COMPLETE;
                break;
                default:
            ...
            const OBC_CUBEADCSsetCommissioningStatusRequestData_t* pRequestData)
{
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        if(sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS))
        {
            ...
            {
                eOpResult = OBC_CUBEADCS_STANDARDRESULT_INVALID_ARGS;
            }
        }
        else
        {
