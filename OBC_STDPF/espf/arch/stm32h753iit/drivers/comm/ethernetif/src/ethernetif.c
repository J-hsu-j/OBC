...
static void low_level_init(struct netif *netif)
{
    ...
    if (NULL == os_task_hnd)
    {
        ...
        task_mon_task_initialized(TASK_ID_ETHERNET);
        task_mon_register_for_stats(TASK_ID_ETHERNET, os_task_hnd);
    }
...
static __attribute__((noreturn)) void ethernetif_input(void *argument)
{
    ...
    for (;;)
    {
        ...
        task_mon_i_am_alive(TASK_ID_ETHERNET);
        task_mon_low_stack_check(TASK_ID_ETHERNET);
    }
}
