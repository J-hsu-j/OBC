...
typedef void (*pfUartInitDeinitCb_t) (const sMACConfig_t * cfg);
...
typedef struct {
    ...
    sMACDispatcher_t sDispAlt;      /**< Alternative Dispatcher which can be used for specific types of frames in parallel to sDisp */
