...
/** @brief To be used in gyroscope panel-sensor configurations, most likely in the future other sensors will move to this enumeration */
typedef enum
{
...
/** @brief The temperature reading is in tens of degrees so 25 C -> 250 and this converts from 250 -> 25 C */
#define TMP122_CONV_FROM_TEN_DEG_TO_DEG (10)
/*
*********************************************************************************************
* EXTERNAL TYPES DECLARATIONS
*********************************************************************************************
*/
/** @brief Determine which axis of the gyroscope array is read */
typedef enum
{
    PANEL_GYROS_AXIS_X,
    PANEL_GYROS_AXIS_Y,
    PANEL_GYROS_AXIS_Z,
    PANEL_GYROS_AXIS_ALL,
    PANEL_GYROS_AXIS_NUMBER
} PANEL_GYROS_AXIS;
...
status_t GetMagnetorque(uint8_t Panel, PANEL_TRQ_str *data);
