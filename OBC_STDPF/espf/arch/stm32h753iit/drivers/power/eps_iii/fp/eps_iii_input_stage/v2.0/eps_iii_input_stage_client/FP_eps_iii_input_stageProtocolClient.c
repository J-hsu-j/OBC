/*!
********************************************************************************************
* @file FP_eps_iii_input_stageProtocolClient.c
...
} PACKED_STRUCT eps_iii_input_stageget_telemetryProtocolRequestData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
    eps_iii_input_stageget_telemetryResponseData_t data;
} PACKED_STRUCT eps_iii_input_stageget_telemetryProtocolResponseData_t;
 ...
 *
 **********************************************************************/
const ESSA_Stack_FunctionProtocolInfo_t FP_eps_iii_input_stageProtocolClientInfo = {
    .u16ProtocolId    = ES_SAT_FUNC_PROTOCOL_ID_EPS_III_INPUT_STAGE,
 ...
 *
 **********************************************************************/
static eps_iii_input_stage_ClientApi_t *pCliApiHnd = NULL;

static const ProtocolFuncArrayEntry_t fs_aFuncArray[] = {
    { EPS_III_INPUT_STAGE_GET_TELEMETRY_FUNCRESP_ID, fs_get_telemetryResp }
};
...
static void fs_get_telemetryResp(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo)
{
    eps_iii_input_stageget_telemetryProtocolResponseData_t *fullresponse = (eps_iii_input_stageget_telemetryProtocolResponseData_t *) fp_DataInfo->pu8Data;
    eps_iii_input_stageget_telemetryResponseData_t *responsePayload = NULL;
    RespContext_t responseCtx;

    STATIC_ASSERT_SIZE_CHECK(eps_iii_input_stageget_telemetryProtocolResponseData_t);
    ...
    responsePayload = (eps_iii_input_stageget_telemetryResponseData_t *) &fullresponse->data;
#else   // #ifndef BIG_ENDIAN_PLATFORM
    // TBD: Deserialize response fields
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    if (pCliApiHnd->eps_iii_input_stage_get_telemetryResponseHandler != NULL)
    {
        ...
        pCliApiHnd->eps_iii_input_stage_get_telemetryResponseHandler(&responseCtx,
...
{
    return (ESSA_pStack_FunctionProtocolInfo_t) &FP_eps_iii_input_stageProtocolClientInfo;
}
...
{
#ifndef BIG_ENDIAN_PLATFORM
    eps_iii_input_stageget_telemetryProtocolRequestData_t requestParams;
#else  // #ifndef BIG_ENDIAN_PLATFORM
    uint8_t requestParams[sizeof(eps_iii_input_stageget_telemetryProtocolRequestData_t)] = { 0 };
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    ESSATMAC_ErrCodes sendResult = ESSATMAC_EC_NULL;

    STATIC_ASSERT_SIZE_CHECK(eps_iii_input_stageget_telemetryProtocolRequestData_t);
    ...
    if (ctx != NULL)
    {
        ...
        requestParams.hdr.protoId = ES_SAT_FUNC_PROTOCOL_ID_EPS_III_INPUT_STAGE;
        requestParams.hdr.funcId  = EPS_III_INPUT_STAGE_GET_TELEMETRY_FUNC_ID;
    ...
    // TBD: Serialize request fields
        ...
        sendResult = ESSA_Stack_SendFrameEx((ESSASNetInterface) ctx->nInterfaceNumber,
                                            ...
                                            (uint8_t *) requestParams,
#endif // #ifndef BIG_ENDIAN_PLATFORM
                                            sizeof(eps_iii_input_stageget_telemetryProtocolRequestData_t),
