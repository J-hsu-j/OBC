...
mod_op_status_id_t eps_ii_deinit(sys_init_level_id_t level)
{
    if (INIT_OS == level)
    {
        task_mon_set_task_policy(TASK_ID_EPS_II, TASK_MON_POLICY_DONT_CARE);
    }
    return STATUS_OK;
}
...
EPSII_PDM_1_SGGPIO_OnOff_mask_t eps_ii_channel_to_gpio(eps_ii_ctrl_ch_t ch)
{
    switch (ch)
    {
        case EPS_II_CTRL_DigOUT1:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT1;
        case EPS_II_CTRL_DigOUT2:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT2;
        case EPS_II_CTRL_DigOUT3:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT3;
        case EPS_II_CTRL_DigOUT4:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT4;
        case EPS_II_CTRL_DigOUT5:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT5;
        case EPS_II_CTRL_DigOUT6:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT6;
        case EPS_II_CTRL_DigOUT7:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT7;
        case EPS_II_CTRL_DigOUT8:
            return EPSII_PDM_1_SGGPIO_ONOFF_MASK_SGGPIOBM_DigOUT8;
        default:
            CRIT_ASSERT(false);
...
EPSII_PDM_1_SGPO_ON_Off_Bitmask_t eps_ii_channel_to_sgpo(eps_ii_ctrl_ch_t ch)
{
    switch (ch)
    {
        case EPS_II_CTRL_BBUS_RAWOutput:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_BBUS_RAWOutputEnable;
        case EPS_II_CTRL_12V_Master:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_12V_MasterEnable;
        case EPS_II_CTRL_12V_SP1_3:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_12V_SP1_3_Enable;
        case EPS_II_CTRL_12V_SP1_4:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_12V_SP1_4_Enable;
        case EPS_II_CTRL_12V_SP1_5:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_12V_SP1_5_Enable;
        case EPS_II_CTRL_5V_Ch1_Master:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_5V_Ch1_MasterEnable;
        case EPS_II_CTRL_5V_Ch1_SP2_3:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_5V_Ch1_SP2_3_Enable;
        case EPS_II_CTRL_5V_Ch1_SP2_4:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_5V_Ch1_SP2_4_Enable;
        case EPS_II_CTRL_5V_Ch2_Master:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_5V_Ch2_MasterEnable;
        case EPS_II_CTRL_5V_Ch2_SP1_6:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_5V_Ch2_SP1_6_Enable;
        case EPS_II_CTRL_5V_Ch2_SP1_7:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_5V_Ch2_SP1_7_Enable;
        case EPS_II_CTRL_3V3_Ch1_Master:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_3V3_Ch1_MasterEnable;
        case EPS_II_CTRL_3V3_Ch1_SP2_5:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_3V3_Ch1_SP2_5_Enable;
        case EPS_II_CTRL_3V3_Ch1_SP2_6:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_3V3_Ch1_SP2_6_Enable;
        case EPS_II_CTRL_3V3_Ch1_SP2_7:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_3V3_Ch1_SP2_7_Enable;
        case EPS_II_CTRL_3V3_Ch2_Master:
            return EPSII_PDM_1_SGPO_ON_OFF_BITMASK_SGPOBM_3V3_Ch2_MasterEnable;
        default:
            CRIT_ASSERT(false);
