...
#define CP_CMD_COMM_GW_FP_SEND                   ((uint16_t) 1213)
#define CP_CMD_COMM_GW_CSP_SEND                  ((uint16_t) 1214)
...
ESTL_CP_REGISTER_COMMAND(CP_CMD_COMM_GW_FP_SEND,                OnESCP_CommandReceived, OnESCP_CmdCancelRequest)
ESTL_CP_REGISTER_COMMAND(CP_CMD_COMM_GW_CSP_SEND,               OnESCP_CommandReceived, OnESCP_CmdCancelRequest)
#endif
...
#if defined(COMM_GW_ENABLED)
ESTL_CP_HANDLER_REGISTER_COMMAND(CP_CMD_COMM_GW_FP_SEND,               cp_cmd_handler_comm_gw_generic_send)
ESTL_CP_HANDLER_REGISTER_COMMAND(CP_CMD_COMM_GW_CSP_SEND,              cp_cmd_handler_comm_gw_generic_send)
#endif
