...
***************************************************************************************************
*/
/** @brief List of modules for the Standard Platform */
typedef enum
{
    SYS_MODULE_ID_EPS_I,
    ...
    SYS_MODULE_ID_EPS_III,
    SYS_MODULE_ID_MAX
} sys_module_id_t;

/** @brief List of bool corresponding to the different modules, determining if the are active or inactive */
typedef struct
{
    safe_bool_t mod_activation_state[SYS_MODULE_ID_MAX]; // activation states for the individual modules
} instance_cfg_payload_t;

/** @brief Configuration binary structure */
typedef struct
{
...
***************************************************************************************************
*/
/** @brief Signature precedes the configuration information */
