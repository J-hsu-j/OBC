...
// Agent_change_1: UART6 TX bench test 需要的外部 handle 宣告（只在開啟 PAYLOAD_UART6_TX_TEST 時才使用）/////////
#if defined(PAYLOAD_UART6_TX_TEST)
extern UART_HandleTypeDef g_payload_uart6;
#endif
////////////////////////////////////////////////////////////////////////////
...
// Agent_change_1: USART6 IRQ routing（bench test 開啟時導到 HAL_UART_IRQHandler，否則維持 Error_Handler）/////////
void USART6_IRQHandler(void)
{
#if defined(PAYLOAD_UART6_TX_TEST)
	HAL_UART_IRQHandler(&g_payload_uart6);
#else
	Error_Handler();
#endif
}
