...
STATIC sds_op_status_t sensor_panel_temp_get_data_in_deg_c(sds_panel_temp_data_t *const p_data_dst)
{
    ...
    p_data_dst->pan_temp_1_deg_c = (double_t)panel_temp_data_raw[0] / TMP122_CONV_FROM_TEN_DEG_TO_DEG;
    p_data_dst->pan_temp_2_deg_c = (double_t)panel_temp_data_raw[1] / TMP122_CONV_FROM_TEN_DEG_TO_DEG;
    p_data_dst->pan_temp_3_deg_c = (double_t)panel_temp_data_raw[2] / TMP122_CONV_FROM_TEN_DEG_TO_DEG;
    p_data_dst->pan_temp_4_deg_c = (double_t)panel_temp_data_raw[3] / TMP122_CONV_FROM_TEN_DEG_TO_DEG;
    p_data_dst->pan_temp_5_deg_c = (double_t)panel_temp_data_raw[4] / TMP122_CONV_FROM_TEN_DEG_TO_DEG;
    p_data_dst->pan_temp_6_deg_c = (double_t)panel_temp_data_raw[5] / TMP122_CONV_FROM_TEN_DEG_TO_DEG;

    ES_TRACE_DEBUG("%s PANEL TEMP DATA IN DEG C---1:%d, 2:%d, 3:%d, 4:%d, 5:%d, 6:%d\r", SDS_DBG_HEAD,
