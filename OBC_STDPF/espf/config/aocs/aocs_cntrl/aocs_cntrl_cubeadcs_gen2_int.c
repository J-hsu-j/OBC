...
static int16_t fs_aocs_cntrl_cubeadcs_gen2_int_select_wheel_speed(const TypesCommonFrameworkTypes1_NodeType wheel_type,
                                                                          ...
                                                                          aocs_cntrl_est_ang_rate_norm *p_est_ang_rate_norm)
{
    ...
    if ((NULL != p_est_ang_rates) && (NULL != p_est_ang_rate_norm))
    {
        ...
        TypesCubeComputerControlProgram8_TlmEstimatorMain est_telemetry;
        const ErrorCode                                   err = CubeADCS_Gen2_CubeComputerControlProgram8_getTlmEstimatorMainRequestGw(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_COMPUTER,
                                                                                                                                       &est_telemetry,
                                                                  ...
                                                                  const F32                                 speed_nss)
{
    ...
    switch (wheel_type)
    {
        case TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_TYPE_CUBE_WHEEL:
        ...
        case TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_TYPE_CUBE_NODE_NSSRWL:
...
static aocs_cntrl_res_t fs_aocs_cntrl_cubeadcs_gen2_int_get_meas_wheel_speed(aocs_cntrl_wheel_speed_t *p_meas_wheel_speed)
{
    ...
    {
        TypesCubeComputerControlProgram8_TlmSensorRawRwl rwl_meas_cube;
        TypesCubeComputerControlProgram8_TlmRwlNssRwlRaw rwl_meas_nss;

        const ErrorCode err_meas_cube = CubeADCS_Gen2_CubeComputerControlProgram8_getTlmSensorRawRwlRequestGw(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_COMPUTER,
                                                                                                              &rwl_meas_cube,
                                                                                                              CUBEADCS_GEN2_DEFAULT_CRIT_SECTION_TIMEOUT);
        const ErrorCode err_meas_nss  = CubeADCS_Gen2_CubeComputerControlProgram8_getTlmRwlNssRwlRawRequestGw(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_COMPUTER,
                                                                                                              &rwl_meas_nss,
                                                                                                              CUBEADCS_GEN2_DEFAULT_CRIT_SECTION_TIMEOUT);

        TypesCommonFrameworkTypes1_NodeType wheel_type = cubeadcs_gen2_get_node_type(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_RWL_0);
        ...
        wheel_type                     = cubeadcs_gen2_get_node_type(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_RWL_1);
        ...
        wheel_type                     = cubeadcs_gen2_get_node_type(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_RWL_2);
        ...
        wheel_type                     = cubeadcs_gen2_get_node_type(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_RWL_3);
...
static aocs_cntrl_res_t fs_aocs_cntrl_cubeadcs_gen2_int_get_cntrl_status(bool *const p_cntrl_status)
{
    ...
    {
        TypesCubeComputerControlProgram8_ConMode cntrl_mode;
        ErrorCode                                err = CubeADCS_Gen2_CubeComputerControlProgram8_getConModeRequestGw(TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_COMPUTER,
                                                                                                                     &cntrl_mode,
                                                                                                                     CUBEADCS_GEN2_DEFAULT_CRIT_SECTION_TIMEOUT);
        if (CUBEOBC_ERROR_OK == err)
        {
            *p_cntrl_status = false;
            if (cntrl_mode.controlMode != TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_NONE)
            {
                *p_cntrl_status = true;
            }
