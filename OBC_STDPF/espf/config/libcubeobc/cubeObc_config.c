...
mod_op_status_id_t cube_adcs_g2_deinit(sys_init_level_id_t level)
{
    ...
    switch (level)
    {
        ...
        case INIT_OS:
            ...
            task_mon_set_task_policy(TASK_ID_CUBEADCS_GEN2_COMM, TASK_MON_POLICY_DONT_CARE);
            task_mon_set_task_policy(TASK_ID_CUBEADCS_GEN2_TRANSFER, TASK_MON_POLICY_DONT_CARE);
