...
typedef struct
{
    ...
    DATA_CACHE_Eps2Inst1_FDIR_CMD_EXEC_STATUS_type_t fdir_eps_ii_bp_inst1_cmd_exec_status_data;
...
static const dc_cfg_entry_immut_t dc_data_cfg[DC_DID_MAX] =
{
    ...
    // fdir_eps_ii_bp_inst1_cmd_exec_status_data
    {
        .data_id = DC_ATTR_ID_FDIR_EPS_II_BP_INST1_CMD_EXEC_STATUS_DATA,
        .p_data_raw = &dc_instance.fdir_eps_ii_bp_inst1_cmd_exec_status_data,
        .data_size = sizeof(dc_instance.fdir_eps_ii_bp_inst1_cmd_exec_status_data),
        .data_timeout = 40000U
    },
...
{
    return dc_get_raw_data(DC_DID_FDIR_EPS_II_BP_INST1_CMD_EXEC_STATUS_DATA,
                           p_data,
                           sizeof(DATA_CACHE_Eps2Inst1_FDIR_CMD_EXEC_STATUS_type_t),
                           0U,
                           sizeof(DATA_CACHE_Eps2Inst1_FDIR_CMD_EXEC_STATUS_type_t));
}
...
{
    dc_set_raw_data(DC_DATA_INPUT_INTERNAL, DC_DID_FDIR_EPS_II_BP_INST1_CMD_EXEC_STATUS_DATA, p_new_data, sizeof(DATA_CACHE_Eps2Inst1_FDIR_CMD_EXEC_STATUS_type_t));
}
