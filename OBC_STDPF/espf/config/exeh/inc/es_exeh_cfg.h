...
typedef enum
{
    ...
    // Exceptions from the coordsys service
    eEXEHModuleID_COORDSYS,
    eEXEHModuleID_COUNT
} eEXEHModuleID_t;
...
typedef enum
{
    eEXEH_SDMNGR_EXCEPTION_FR_DISK_ERR = 1, // This mirrors the error types from ff.h:fm_result_t where 0 is FM_RES_OK.
...
// enumeration for DTC type eEXEHModuleID_ACS
typedef enum
{
    EXEH_ACS_INVALID_STATE,
    EXEH_ACS_INVALID_STATE_SWITCH,
    EXEH_ACS_MTQ_DC_READ_FAIL,
    EXEH_ACS_MTQ_DIVISION_BY_ZERO,
    EXEH_ACS_COUNT
} exeh_acs_error_codes_t;
// end of enumeration for DTC type eEXEHModuleID_ACS
...
// enumeration for DTC type eEXEHModuleID_COORDSYS
typedef enum
{
    EXEH_COORDSYS_NONE,
    EXEH_COORDSYS_NVM_CONFIG_CORRUPTED,
    EXEH_COORDSYS_FRAME_TYPE_INVALID,
    EXEH_COORDSYS_SATELLITE_AXIS_INVALID,
    EXEH_COORDSYS_ELEMENT_OUT_OF_RANGE,
    EXEH_COORDSYS_INVALID_ROW_OR_COLUMN,
    EXEH_COORDSYS_COUNT
} exeh_coordsys_error_codes_t;
// end of enumeration for DTC type eEXEHModuleID_COORDSYS
