...
typedef struct
{
    ...
    const uint16_t        dc_did_id_SI_body_frame;      /**< The Data Cache enum ID that needs to be updated with the sensor data, converted in SI units and transformed in the body coordinate frame */
    const uint32_t        dc_did_id_SI_body_frame_size; /**< The Data Cache enum ID size */
