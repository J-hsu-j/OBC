...
#ifndef FP_SDSPROTOCOLTYPES_H
#define FP_SDSPROTOCOLTYPES_H
 ...
 **********************************************************************/
/*
    User configurable enumeration of the different sensors that will be sampled
*/
#define SDS_AVAILABLESENSORS_SENSOR_GYRO ((uint8_t) 0)
#define SDS_AVAILABLESENSORS_SENSOR_MAG_PRIMARY ((uint8_t) 1)
#define SDS_AVAILABLESENSORS_SENSOR_MAG_SECONDARY ((uint8_t) 2)
#define SDS_AVAILABLESENSORS_SENSOR_CSS ((uint8_t) 3)
#define SDS_AVAILABLESENSORS_SENSOR_PANEL_TEMP ((uint8_t) 4)
#define SDS_AVAILABLESENSORS_SENSOR_GYRO_TEMP ((uint8_t) 5)
#define SDS_AVAILABLESENSORS_MAX_CNT  ((uint8_t) 6)
typedef uint8_t SDS_AvailableSensors_t;
...
#define SDS_SENSTYPECFGNUM_SENS_PANEL_TEMP ((uint8_t) 3)
#define SDS_SENSTYPECFGNUM_SENS_GYRO_TEMP ((uint8_t) 4)
#define SDS_SENSTYPECFGNUM_SENS_RES_0 ((uint8_t) 5)
#define SDS_SENSTYPECFGNUM_SENS_RES_1 ((uint8_t) 6)
#define SDS_SENSTYPECFGNUM_MAX_CNT  ((uint8_t) 7)
...
typedef struct {
    SDS_AvailableSensors_t eSensTypeId;
...
#endif  // #ifndef FP_SDSPROTOCOLTYPES_H
