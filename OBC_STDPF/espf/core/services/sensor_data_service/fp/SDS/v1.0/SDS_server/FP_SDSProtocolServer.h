...
#ifndef FP_SDSPROTOCOLSERVER_H
#define FP_SDSPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
#define SDS_PROTOCOL_VERSION_MAJOR   ((uint8_t) 1)
#define SDS_PROTOCOL_VERSION_MINOR   ((uint8_t) 0)
 ...
 *
 **********************************************************************/
typedef void (*pfSDS_setSensReadFreqRequestHandler_t)(ReqContext_t *ctx, const SDSsetSensReadFreqRequestData_t *pRequestData);
typedef void (*pfSDS_getSensReadFreqRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfSDS_getSensStateRequestHandler_t)(ReqContext_t *ctx, const SDSgetSensStateRequestData_t *pRequestData);
typedef void (*pfSDS_getSensErrRequestHandler_t)(ReqContext_t *ctx, const SDSgetSensErrRequestData_t *pRequestData);
typedef void (*pfSDS_getSensRegRequestHandler_t)(ReqContext_t *ctx, const SDSgetSensRegRequestData_t *pRequestData);
typedef void (*pfSDS_setSensRegRequestHandler_t)(ReqContext_t *ctx, const SDSsetSensRegRequestData_t *pRequestData);
...
#endif  // #ifndef FP_SDSPROTOCOLSERVER_H
