...
static pl_op_status_t sxband_pl_ctrl_init(const pl_instance_id_t instance_id, const pl_config_t *const p_init_cfg, const p_pl_event_notify_t p_event_notify_cb);
static pl_op_status_t sxband_pl_ctrl_deinit(const pl_instance_id_t instance_id);
static pl_op_status_t sxband_pl_ctrl_start(const pl_instance_id_t instance_id, const pl_config_t *const p_start_cfg);
