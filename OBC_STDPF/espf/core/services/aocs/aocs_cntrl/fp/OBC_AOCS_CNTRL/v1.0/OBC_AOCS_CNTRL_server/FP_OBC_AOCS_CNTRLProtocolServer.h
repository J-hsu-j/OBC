...
#ifndef FP_OBC_AOCS_CNTRLPROTOCOLSERVER_H
#define FP_OBC_AOCS_CNTRLPROTOCOLSERVER_H
...
typedef void (*pfOBC_AOCS_CNTRL_setMaxTimeForAutoLoggingRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLsetMaxTimeForAutoLoggingRequestData_t *pRequestData);
typedef void (*pfOBC_AOCS_CNTRL_startLoggingRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLstartLoggingRequestData_t *pRequestData);
typedef void (*pfOBC_AOCS_CNTRL_getDataTypeForAssessmentRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_AOCS_CNTRL_setDataTypeForAssessmentRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLsetDataTypeForAssessmentRequestData_t *pRequestData);
typedef void (*pfOBC_AOCS_CNTRL_getThresholdLevelsRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_AOCS_CNTRL_setThresholdLevelsRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLsetThresholdLevelsRequestData_t *pRequestData);
...
typedef void (*pfOBC_AOCS_CNTRL_setUpdateIntervalRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLsetUpdateIntervalRequestData_t *pRequestData);
typedef void (*pfOBC_AOCS_CNTRL_getSamplesToSkipRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_AOCS_CNTRL_setSamplesToSkipRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLsetSamplesToSkipRequestData_t *pRequestData);
typedef void (*pfOBC_AOCS_CNTRL_setAocsStateRequestHandler_t)(ReqContext_t *ctx, const OBC_AOCS_CNTRLsetAocsStateRequestData_t *pRequestData);
...
#endif  // #ifndef FP_OBC_AOCS_CNTRLPROTOCOLSERVER_H
