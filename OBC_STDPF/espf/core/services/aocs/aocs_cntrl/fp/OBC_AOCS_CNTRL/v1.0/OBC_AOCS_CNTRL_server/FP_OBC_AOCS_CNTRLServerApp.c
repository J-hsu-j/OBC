...
{
  .OBC_AOCS_CNTRL_resetAOCSPMbuffRequestHandler = OBC_AOCS_CNTRL_resetAOCSPMbuffRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getMaxTimeForAutoLoggingRequestHandler = OBC_AOCS_CNTRL_getMaxTimeForAutoLoggingRequestHandlerImpl,
  .OBC_AOCS_CNTRL_setMaxTimeForAutoLoggingRequestHandler = OBC_AOCS_CNTRL_setMaxTimeForAutoLoggingRequestHandlerImpl,
  .OBC_AOCS_CNTRL_startLoggingRequestHandler = OBC_AOCS_CNTRL_startLoggingRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getDataTypeForAssessmentRequestHandler = OBC_AOCS_CNTRL_getDataTypeForAssessmentRequestHandlerImpl,
  .OBC_AOCS_CNTRL_setDataTypeForAssessmentRequestHandler = OBC_AOCS_CNTRL_setDataTypeForAssessmentRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getThresholdLevelsRequestHandler = OBC_AOCS_CNTRL_getThresholdLevelsRequestHandlerImpl,
  .OBC_AOCS_CNTRL_setThresholdLevelsRequestHandler = OBC_AOCS_CNTRL_setThresholdLevelsRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getPMOutputRequestHandler = OBC_AOCS_CNTRL_getPMOutputRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getConfigRequestHandler = OBC_AOCS_CNTRL_getConfigRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getUpdateIntervalRequestHandler = OBC_AOCS_CNTRL_getUpdateIntervalRequestHandlerImpl,
  .OBC_AOCS_CNTRL_setUpdateIntervalRequestHandler = OBC_AOCS_CNTRL_setUpdateIntervalRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getSamplesToSkipRequestHandler = OBC_AOCS_CNTRL_getSamplesToSkipRequestHandlerImpl,
  .OBC_AOCS_CNTRL_setSamplesToSkipRequestHandler = OBC_AOCS_CNTRL_setSamplesToSkipRequestHandlerImpl,
  .OBC_AOCS_CNTRL_setAocsStateRequestHandler = OBC_AOCS_CNTRL_setAocsStateRequestHandlerImpl,
  .OBC_AOCS_CNTRL_getAocsStateRequestHandler = OBC_AOCS_CNTRL_getAocsStateRequestHandlerImpl
};
