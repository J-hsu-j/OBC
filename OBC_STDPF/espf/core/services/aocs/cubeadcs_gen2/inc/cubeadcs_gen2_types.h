...
#define CUBEADCS_GEN2_BDT_FILE_NAME_SZ (FM_MAX_PATH)
...
typedef struct
{
    ...
    fm_file_obj_t          file_handle;                                   /**< File pointer */
...
typedef struct
{
    TypesCubeComputerControlProgram8_ConModeSelect control_mode;
...
typedef struct
{
    TypesCubeComputerControlProgram8_EstModeSelect estimator_type;
...
typedef struct
{
    TypesCubeComputerCommon3_PowerState            pwr_state;
    TypesCubeComputerControlProgram8_ConModeSelect cntrl_mode;
    TypesCubeComputerControlProgram8_EstModeSelect est_mode_main;
    TypesCubeComputerControlProgram8_EstModeSelect est_mode_backup;
