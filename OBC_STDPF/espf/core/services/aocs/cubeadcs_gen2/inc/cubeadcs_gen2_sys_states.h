 ...
 *
 */
bool cubeadcs_gen2_is_sys_state_combo_valid(const TypesCubeComputerControlProgram8_ConModeSelect control_mode, const TypesCubeComputerControlProgram8_EstModeSelect estimation_mdoe);
