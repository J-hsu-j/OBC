...
#ifndef FP_OBC_CUBEADCS_GEN2PROTOCOLSERVER_H
#define FP_OBC_CUBEADCS_GEN2PROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
#define OBC_CUBEADCS_GEN2_PROTOCOL_VERSION_MAJOR   ((uint8_t) 5)
 ...
 *
 **********************************************************************/
typedef void (*pfOBC_CUBEADCS_GEN2_reqStateMachineStateChangeRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2reqStateMachineStateChangeRequestData_t *pRequestData);
...
typedef void (*pfOBC_CUBEADCS_GEN2_reqSoftResetAndModeRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2reqSoftResetAndModeRequestData_t *pRequestData);
...
typedef void (*pfOBC_CUBEADCS_GEN2_download_evtRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2download_evtRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_download_evt_statusRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_GEN2_download_tlmRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2download_tlmRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_download_tlm_statusRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_GEN2_download_img_directRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2download_img_directRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandler_t)(ReqContext_t *ctx);
...
typedef void (*pfOBC_CUBEADCS_GEN2_set_commissioning_statusRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2set_commissioning_statusRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_get_tlm_cfgRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_GEN2_set_tlm_cfgRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2set_tlm_cfgRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_get_nvm_system_states_cfgRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2get_nvm_system_states_cfgRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_set_nvm_system_states_cfgRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2set_nvm_system_states_cfgRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_fw_update_cube_computerRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2fw_update_cube_computerRequestData_t *pRequestData);
typedef void (*pfOBC_CUBEADCS_GEN2_fw_update_cube_computer_statusRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfOBC_CUBEADCS_GEN2_fw_update_cube_nodeRequestHandler_t)(ReqContext_t *ctx, const OBC_CUBEADCS_GEN2fw_update_cube_nodeRequestData_t *pRequestData);
...
typedef struct {
    ...
    pfOBC_CUBEADCS_GEN2_download_img_directRequestHandler_t OBC_CUBEADCS_GEN2_download_img_directRequestHandler;
    pfOBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandler_t OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandler;
    pfOBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandler_t OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandler;
    pfOBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandler_t OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandler;
...
#endif  // #ifndef FP_OBC_CUBEADCS_GEN2PROTOCOLSERVER_H
