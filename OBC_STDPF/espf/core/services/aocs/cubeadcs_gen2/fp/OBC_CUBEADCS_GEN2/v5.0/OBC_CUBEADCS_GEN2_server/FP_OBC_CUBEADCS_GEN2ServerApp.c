...
static void OBC_CUBEADCS_GEN2_download_img_directRequestHandlerImpl(ReqContext_t* pReqCtx,
            const OBC_CUBEADCS_GEN2download_img_directRequestData_t* pRequestData);

static void OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandlerImpl(ReqContext_t* pReqCtx);

static void OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandlerImpl(ReqContext_t* pReqCtx);

static void OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandlerImpl(ReqContext_t* pReqCtx);
...
{
  .OBC_CUBEADCS_GEN2_reqStateMachineStateChangeRequestHandler = OBC_CUBEADCS_GEN2_reqStateMachineStateChangeRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_getStateMachineStateRequestHandler = OBC_CUBEADCS_GEN2_getStateMachineStateRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_getOpStatusRequestHandler = OBC_CUBEADCS_GEN2_getOpStatusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_reqSoftResetAndModeRequestHandler = OBC_CUBEADCS_GEN2_reqSoftResetAndModeRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_get_events_since_last_power_upRequestHandler = OBC_CUBEADCS_GEN2_get_events_since_last_power_upRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_clear_events_since_last_power_upRequestHandler = OBC_CUBEADCS_GEN2_clear_events_since_last_power_upRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_download_evtRequestHandler = OBC_CUBEADCS_GEN2_download_evtRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_download_evt_statusRequestHandler = OBC_CUBEADCS_GEN2_download_evt_statusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_download_tlmRequestHandler = OBC_CUBEADCS_GEN2_download_tlmRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_download_tlm_statusRequestHandler = OBC_CUBEADCS_GEN2_download_tlm_statusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_download_img_directRequestHandler = OBC_CUBEADCS_GEN2_download_img_directRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandler = OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandler = OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandler = OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_get_fdir_statsRequestHandler = OBC_CUBEADCS_GEN2_get_fdir_statsRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_clear_fdir_statsRequestHandler = OBC_CUBEADCS_GEN2_clear_fdir_statsRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_get_commissioning_statusRequestHandler = OBC_CUBEADCS_GEN2_get_commissioning_statusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_set_commissioning_statusRequestHandler = OBC_CUBEADCS_GEN2_set_commissioning_statusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_get_tlm_cfgRequestHandler = OBC_CUBEADCS_GEN2_get_tlm_cfgRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_set_tlm_cfgRequestHandler = OBC_CUBEADCS_GEN2_set_tlm_cfgRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_get_nvm_system_states_cfgRequestHandler = OBC_CUBEADCS_GEN2_get_nvm_system_states_cfgRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_set_nvm_system_states_cfgRequestHandler = OBC_CUBEADCS_GEN2_set_nvm_system_states_cfgRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_fw_update_cube_computerRequestHandler = OBC_CUBEADCS_GEN2_fw_update_cube_computerRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_fw_update_cube_computer_statusRequestHandler = OBC_CUBEADCS_GEN2_fw_update_cube_computer_statusRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_fw_update_cube_nodeRequestHandler = OBC_CUBEADCS_GEN2_fw_update_cube_nodeRequestHandlerImpl,
  .OBC_CUBEADCS_GEN2_fw_update_cube_node_statusRequestHandler = OBC_CUBEADCS_GEN2_fw_update_cube_node_statusRequestHandlerImpl
};
            ...
            const OBC_CUBEADCS_GEN2reqStateMachineStateChangeRequestData_t* pRequestData)
{
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_RESET == eHSM_StdEvent_Reset);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_EVENT_MARKER_ACQUIRED == ev_cubeadcs_gen2_sm_event_marker_acquired);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_REQUEST_FDIR == ev_cubeadcs_gen2_sm_request_fdir);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_REQUEST_STATE_CHANGE == ev_cubeadcs_gen2_sm_request_a_state_change);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_CHECK_COMPLETED == ev_cubeadcs_gen2_sm_check_completed);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_EVENT_DOWNLOAD_COMPLETED == ev_cubeadcs_gen2_sm_event_download_completed);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_STATE_CHANGE_COMPLETED == ev_cubeadcs_gen2_sm_state_change_completed);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_FDIR_COMPLETED == ev_cubeadcs_gen2_sm_fdir_completed);
        static_assert(OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_ADCS_RESETED == ev_cubeadcs_gen2_sm_adcs_reseted);
        ...
        if (false != sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS_GEN2))
        {
            ...
            event_ctx.sys_state.sys_state_core_cfg.pwr_state.extGyro0Power =
                pRequestData->sState_change_event_args.sCore_args.sNodes_pwr_states.eExtGyro0;
            event_ctx.sys_state.sys_state_core_cfg.pwr_state.extGyro1Power =
                pRequestData->sState_change_event_args.sCore_args.sNodes_pwr_states.eExtGyro1;
...
static void OBC_CUBEADCS_GEN2_getOpStatusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        if (false != sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS_GEN2))
        {
            ...
            sOp_status_app.eRun_mode = (OBC_CUBEADCS_GEN2_AdcsRunMode_t)op_status.app_tlm.run_mode.runMode;
            ...
            sOp_status_app.eOp_state = (OBC_CUBEADCS_GEN2_AdcsOpState_t)op_status.app_tlm.op_state.opState;
            ...
            const OBC_CUBEADCS_GEN2reqSoftResetAndModeRequestData_t* pRequestData)
{
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        if (false != sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS_GEN2))
        {
            if(OBC_CUBEADCS_GEN2_ADCSPROGTYPE_BOOTLOADER == (cubeadcs_gen2_control_program_type_t)pRequestData->eProg_type)
            {
                cubeadcs_gen2_set_stay_in_bootloader(true);
            }
            else
            {
                cubeadcs_gen2_set_stay_in_bootloader(false);
            }
...
static void OBC_CUBEADCS_GEN2_get_events_since_last_power_upRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        if (false != sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS_GEN2))
        {
            ...
            {
                static_assert(sizeof(sAll_events) == sizeof(events_cache.all_read_events), "Size mismatch");
            ...
            const OBC_CUBEADCS_GEN2download_evtRequestData_t* pRequestData)
{
    ESSATMAC_ErrCodes respResult;
    RespContext_t respCtx;
    OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr;
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        tErr = cubeadcs_gen2_transfer_evt(
                (const char*)pRequestData->sFile_name.au8Name,
                (const TypesCubeComputerCommon3_EventLogFilterTransferSetup*)&pRequestData->sSetup);
...
static void OBC_CUBEADCS_GEN2_download_evt_statusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        tErr = cubeadcs_gen2_transfer_evt_status(
            ...
            const OBC_CUBEADCS_GEN2download_tlmRequestData_t* pRequestData)
{
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        static_assert(sizeof(OBC_CUBEADCS_GEN2_TctlmCubeComputerCommon3_TelemetryLogTransferSetup_t) ==
                      sizeof(TypesCubeComputerCommon3_TelemetryLogTransferSetup));

        tErr = cubeadcs_gen2_transfer_tlm(
                (const char*)pRequestData->sFile_name.au8Name,
                (const TypesCubeComputerCommon3_TelemetryLogTransferSetup*)&pRequestData->sSetup);
...
static void OBC_CUBEADCS_GEN2_download_tlm_statusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        tErr = cubeadcs_gen2_transfer_tlm_status(
...
// @START@ Request handler for method OBC_CUBEADCS_GEN2::download_img_direct (ID = 0x00000014)
static void OBC_CUBEADCS_GEN2_download_img_directRequestHandlerImpl(ReqContext_t *pReqCtx,
            const OBC_CUBEADCS_GEN2download_img_directRequestData_t* pRequestData)
{
    ESSATMAC_ErrCodes respResult;
    ...
    // @USER_VAR_SECTION_START@OBC_CUBEADCS_GEN2::download_img_direct@
    // Put your local variables in this section to preserve during merge!
    // @USER_VAR_SECTION_END@OBC_CUBEADCS_GEN2::download_img_direct@
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        // @USER_CODE_SECTION_START@OBC_CUBEADCS_GEN2::download_img_direct@
        
        tErr = cubeadcs_gen2_transfer_img_direct(
                (const char*)pRequestData->sFile_name.au8Name, pRequestData->u32File_handle, pRequestData->eNode);
        
        // @USER_CODE_SECTION_END@OBC_CUBEADCS_GEN2::download_img_direct@

        respResult = OBC_CUBEADCS_GEN2_download_img_directResp(
                        &respCtx,
                        tErr
                     );

        if (respResult != ESSATMAC_EC_OK)
            TRACE_ERROR(ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2, OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_FUNCRESP_ID, respResult);
    }
}
// @END@ Request handler for method OBC_CUBEADCS_GEN2::download_img_direct (ID = 0x00000014)

// @START@ Request handler for method OBC_CUBEADCS_GEN2::download_img_direct_status (ID = 0x00000015)
static void OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ESSATMAC_ErrCodes respResult;
    RespContext_t respCtx;
    ...
    // @USER_VAR_SECTION_START@OBC_CUBEADCS_GEN2::download_img_direct_status@
    // Put your local variables in this section to preserve during merge!
    // @USER_VAR_SECTION_END@OBC_CUBEADCS_GEN2::download_img_direct_status@
    ...
    if (pReqCtx != NULL)
    {
        ...
        // @USER_CODE_SECTION_START@OBC_CUBEADCS_GEN2::download_img_direct_status@
        static_assert(sizeof(OBC_CUBEADCS_GEN2_TctlmCubeComputerCommon3_ImageTransferStatus_t) ==
                                      sizeof(TypesCubeComputerCommon3_ImageTransferStatus));

        tErr = cubeadcs_gen2_transfer_img_direct_status((TypesCubeComputerCommon3_ImageTransferStatus*) &sStatus, (uint8_t*) &sFile_name);

        // @USER_CODE_SECTION_END@OBC_CUBEADCS_GEN2::download_img_direct_status@

        respResult = OBC_CUBEADCS_GEN2_download_img_direct_statusResp(
                        &respCtx,
                        tErr,
                        &sFile_name,
                        &sStatus
        ...
        if (respResult != ESSATMAC_EC_OK)
            TRACE_ERROR(ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2, OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_STATUS_FUNCRESP_ID, respResult);
    }
}
// @END@ Request handler for method OBC_CUBEADCS_GEN2::download_img_direct_status (ID = 0x00000015)

// @START@ Request handler for method OBC_CUBEADCS_GEN2::get_fdir_persistent_errors (ID = 0x00000018)
static void OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ESSATMAC_ErrCodes respResult;
    RespContext_t respCtx;
    ...
    // @USER_VAR_SECTION_START@OBC_CUBEADCS_GEN2::get_fdir_persistent_errors@
    // Put your local variables in this section to preserve during merge!
    // @USER_VAR_SECTION_END@OBC_CUBEADCS_GEN2::get_fdir_persistent_errors@
    ...
    if (pReqCtx != NULL)
    {
        ...
        // @USER_CODE_SECTION_START@OBC_CUBEADCS_GEN2::get_fdir_persistent_errors@
        ...
        // @USER_CODE_SECTION_END@OBC_CUBEADCS_GEN2::get_fdir_persistent_errors@

        respResult = OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsResp(
                        &respCtx,
                        u32Errors,
                        eOp_result
                     );
        ...
        if (respResult != ESSATMAC_EC_OK)
            TRACE_ERROR(ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2, OBC_CUBEADCS_GEN2_GET_FDIR_PERSISTENT_ERRORS_FUNCRESP_ID, respResult);
    }
}
// @END@ Request handler for method OBC_CUBEADCS_GEN2::get_fdir_persistent_errors (ID = 0x00000018)

// @START@ Request handler for method OBC_CUBEADCS_GEN2::clear_fdir_persistent_errors (ID = 0x00000019)
static void OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ESSATMAC_ErrCodes respResult;
    RespContext_t respCtx;
    ...
    // @USER_VAR_SECTION_START@OBC_CUBEADCS_GEN2::clear_fdir_persistent_errors@
    // Put your local variables in this section to preserve during merge!
    // @USER_VAR_SECTION_END@OBC_CUBEADCS_GEN2::clear_fdir_persistent_errors@
    ...
    if (pReqCtx != NULL)
    {
        ...
        // @USER_CODE_SECTION_START@OBC_CUBEADCS_GEN2::clear_fdir_persistent_errors@
        ...
        // @USER_CODE_SECTION_END@OBC_CUBEADCS_GEN2::clear_fdir_persistent_errors@

        respResult = OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsResp(
                        &respCtx,
                        eOp_result
                     );

        if (respResult != ESSATMAC_EC_OK)
            TRACE_ERROR(ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2, OBC_CUBEADCS_GEN2_CLEAR_FDIR_PERSISTENT_ERRORS_FUNCRESP_ID, respResult);
    }
}
// @END@ Request handler for method OBC_CUBEADCS_GEN2::clear_fdir_persistent_errors (ID = 0x00000019)
...
static void OBC_CUBEADCS_GEN2_get_fdir_statsRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ESSATMAC_ErrCodes respResult;
    RespContext_t respCtx;
    OBC_CUBEADCS_GEN2_fdir_stat_t asFdir_logic[15];
    OBC_CUBEADCS_GEN2_StandardResult_t eOp_result;
    ...
    if (pReqCtx != NULL)
    {
        ...
        static_assert(CUBEADCS_GEN2_EVENTS_NODE_COMMUNICATION_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_COMMUNICATION_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_ADCS_CONFIG_VALIDATION_ERROR
                      == OBC_CUBEADCS_GEN2_EVENTS_ENUM_ADCS_CONFIG_VALIDATION_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_NODE_SETUP_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_SETUP_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_NODE_JUMP_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_JUMP_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_MAG_DEPLOY_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_MAG_DEPLOY_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_CONTROL_LOOP_FAILURE == OBC_CUBEADCS_GEN2_EVENTS_ENUM_CONTROL_LOOP_FAILURE);
        static_assert(CUBEADCS_GEN2_EVENTS_NODE_FAILURE == OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_FAILURE);
        static_assert(CUBEADCS_GEN2_EVENTS_CONFIG_PERSIST_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_CONFIG_PERSIST_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_VIRTUAL_WATCHDOG_WARNING == OBC_CUBEADCS_GEN2_EVENTS_ENUM_VIRTUAL_WATCHDOG_WARNING);
        static_assert(CUBEADCS_GEN2_EVENTS_PORT_VALIDATION_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_PORT_VALIDATION_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_AUTO_DISCOVERY_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_AUTO_DISCOVERY_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_CONTROL_LOOP_CRITICAL == OBC_CUBEADCS_GEN2_EVENTS_ENUM_CONTROL_LOOP_CRITICAL);
        static_assert(CUBEADCS_GEN2_EVENTS_GYRO_VOLTAGE_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_GYRO_VOLTAGE_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_GYRO_CRITICAL == OBC_CUBEADCS_GEN2_EVENTS_ENUM_GYRO_CRITICAL);
        static_assert(CUBEADCS_GEN2_EVENTS_VIRTUAL_WATCHDOG_ERROR == OBC_CUBEADCS_GEN2_EVENTS_ENUM_VIRTUAL_WATCHDOG_ERROR);
        static_assert(CUBEADCS_GEN2_EVENTS_MAX == OBC_CUBEADCS_GEN2_EVENTS_ENUM_MAX_CNT);
        ...
        if (false != sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS_GEN2))
        {
            if ( true == cubeadcs_gen2_fdir_get_fdir_ctx(&fdir_ctx_cache) )
            {
                ...
                {
                    asFdir_logic[idx].eEvent_type = (OBC_CUBEADCS_GEN2_events_enum_t)fdir_ctx_cache.fdir_handlers[idx].failure_event;
...
static void OBC_CUBEADCS_GEN2_get_commissioning_statusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        {
            eStatus = OBC_CUBEADCS_GEN2_COMMISSIONINGSTATUS_MAX_CNT;
            eOpResult = OBC_CUBEADCS_GEN2_STANDARDRESULT_NOT_SUPPORTED;
        }
            ...
            const OBC_CUBEADCS_GEN2get_nvm_system_states_cfgRequestData_t* pRequestData)
{
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        // Check compatibility of control mode definitions
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_NO_CONTROL == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_NONE);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_1_AXIS_BDOT == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_BDOT);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_Y_THOMSON == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YSPIN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_3_AXIS_BDOT == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_BDOT_3);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_3_AXIS_LOW_POWER == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_DETUMBLE);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_SUN_Y_AXIS_SPIN_DETUMB == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_YSPIN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_Z_THOMSON == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_ZSPIN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_SUN_Z_AXIS_SPIN_DETUMB == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_ZSPIN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_MAG_CNTRL_GG_BOOM_AND_YAW == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_GGBOOM);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_MAG_CNTRL_GG_BOOM_AND_Z == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_GGSUN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_INITIAL_Y_WHEEL_RAMP_UP == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YWHEEL_INIT);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_INITIAL_Y_WHEEL_PITCH_CNTRL == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YWHEEL);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_3_AXIS == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_XYZWHEEL);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_SUN_TRACKING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_TRACK);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_EO_TARGET_TRACKING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_TGT_TRACK);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_EARTH_TARGET_STEERING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_TGT_STEER);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_GS_TARGET_TRACKING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_GND_TRACK);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_INERTIAL_TARGET_TRACKING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_IRC_TRACK);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_MOON_TRACKING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_MOON_TRACK);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_RW_SAT_TARGET_TRACKING == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SAT_TRACK);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_NADIR_AND_YAW_TO_SUN == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_SUN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_NADIR_AND_YAW_TO_GROUND_TARGET == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_TARGET);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_VELOCITY_AND_ROLL_TO_SUN == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_ROLL_SUN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_VELOCITY_AND_ROLL_TO_GROUND_TARGET == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_ROLL_TARGET);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_NADIR_AND_YAW_BEST_TO_GS == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_TARGET_BEST);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_FMC_TARGET == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_FMC_TARGET);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_YAW_SUN_SPIN == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_SUN_SPIN);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_SUN_DETUMBLE == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_DETUMBLE);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_STOP_RW_CONTROLLED == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_STOP_RW);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_OPEN_LOOP_RW == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_HXYZ_RW);
        static_assert(OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_USER == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_USER);

        // Check compatibility of estimation mode definitions
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_NO_ESIMATOR == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_NONE);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_GYRO_MEASURED_RATES == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_GYRO);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_MAG_EST_RATES == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_MAG_RKF);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_MAG_EST_RATES_WITH_PITCH_EST == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_PITCH_RKF);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_TRIAD == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_TRIAD);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_FULL_STATE_EKF == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_FULL_EKF);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_GYRO_EKF == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_GYRO_EKF);
        static_assert(OBC_CUBEADCS_GEN2_ESTIMATIONMODES_EST_USER == TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_USER);
        ...
        if (false != sys_conf_is_module_active(SYS_MODULE_ID_CUBE_ADCS_GEN2))
        {
            ...
            sSys_states_cfg.eControl_mode = (OBC_CUBEADCS_GEN2_ControlModes_t)sys_state_nvm_cfg.sys_state_cfg[pRequestData->eSys_state_to_get].cntrl_mode;
            sSys_states_cfg.eEstimation_mode_main = (OBC_CUBEADCS_GEN2_EstimationModes_t)sys_state_nvm_cfg.sys_state_cfg[pRequestData->eSys_state_to_get].est_mode_main;
            sSys_states_cfg.eEstimation_mode_backup = (OBC_CUBEADCS_GEN2_EstimationModes_t)sys_state_nvm_cfg.sys_state_cfg[pRequestData->eSys_state_to_get].est_mode_backup;
...
static void OBC_CUBEADCS_GEN2_fw_update_cube_computer_statusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        tErr = cubeadcs_gen2_transfer_boot_cube_space_file_status(
            ...
            const OBC_CUBEADCS_GEN2fw_update_cube_nodeRequestData_t* pRequestData)
{
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        tErr = cubeadcs_gen2_transfer_appl_cube_space_file(
                (const char*)pRequestData->sControl_program_file_name.au8Name,
				(const char*)pRequestData->sConfiguration_file_name.au8Name,
                pRequestData->bForce,
                (TypesCommonFrameworkTypes1_NodeType)pRequestData->eNode_type,
...
static void OBC_CUBEADCS_GEN2_fw_update_cube_node_statusRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    if (pReqCtx != NULL)
    {
        ...
        tErr = cubeadcs_gen2_transfer_appl_cube_space_file_status(
