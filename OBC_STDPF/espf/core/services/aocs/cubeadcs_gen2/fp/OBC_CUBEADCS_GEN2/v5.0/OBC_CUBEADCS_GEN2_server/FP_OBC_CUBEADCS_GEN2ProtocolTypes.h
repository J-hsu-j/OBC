...
#ifndef FP_OBC_CUBEADCS_GEN2PROTOCOLTYPES_H
#define FP_OBC_CUBEADCS_GEN2PROTOCOLTYPES_H
...
#define OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_FUNC_ID ((funcIdType_t) 0x00000014)
#define OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_STATUS_FUNC_ID ((funcIdType_t) 0x00000015)
#define OBC_CUBEADCS_GEN2_GET_FDIR_PERSISTENT_ERRORS_FUNC_ID ((funcIdType_t) 0x00000018)
#define OBC_CUBEADCS_GEN2_CLEAR_FDIR_PERSISTENT_ERRORS_FUNC_ID ((funcIdType_t) 0x00000019)
...
#define OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_FUNCRESP_ID ((funcIdType_t) 0x00000014)
#define OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_STATUS_FUNCRESP_ID ((funcIdType_t) 0x00000015)
#define OBC_CUBEADCS_GEN2_GET_FDIR_PERSISTENT_ERRORS_FUNCRESP_ID ((funcIdType_t) 0x00000018)
#define OBC_CUBEADCS_GEN2_CLEAR_FDIR_PERSISTENT_ERRORS_FUNCRESP_ID ((funcIdType_t) 0x00000019)
...
#define OBC_CUBEADCS_GEN2_TCTLMCOMMONFRAMEWORKENUMS_NODETYPE_TCTLM_COMMON_FRAMEWORK_ENUMS__NODE_TYPE_CUBE_NODE_QUAD ((uint8_t) 16)
#define OBC_CUBEADCS_GEN2_TCTLMCOMMONFRAMEWORKENUMS_NODETYPE_TCTLM_COMMON_FRAMEWORK_ENUMS__NODE_TYPE_CUBE_NODE_QUAD_PST3S ((uint8_t) 17)
#define OBC_CUBEADCS_GEN2_TCTLMCOMMONFRAMEWORKENUMS_NODETYPE_TCTLM_COMMON_FRAMEWORK_ENUMS__NODE_TYPE_CUBE_NODE_QUAD_NSSRWL ((uint8_t) 18)
#define OBC_CUBEADCS_GEN2_TCTLMCOMMONFRAMEWORKENUMS_NODETYPE_TCTLM_COMMON_FRAMEWORK_ENUMS__NODE_TYPE_CUBE_NODE_QUAD_LITEFUFORS ((uint8_t) 19)
#define OBC_CUBEADCS_GEN2_TCTLMCOMMONFRAMEWORKENUMS_NODETYPE_MAX_CNT  ((uint8_t) 20)
...
/*
    Enumeration for the nodes with imaging capabilities, the literals need to match the real ABstractNodeType
*/
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_STR_0 ((uint8_t) 2)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_STR_1 ((uint8_t) 3)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_FSS_0 ((uint8_t) 4)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_FSS_1 ((uint8_t) 5)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_FSS_2 ((uint8_t) 6)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_FSS_3 ((uint8_t) 7)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_HSS_0 ((uint8_t) 8)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_TYPES_COMMON_FRAMEWORK_TYPES_1__NODE_HSS_1 ((uint8_t) 9)
#define OBC_CUBEADCS_GEN2_ABSTRACTIMAGINGNODETYPE_MAX_CNT  ((uint8_t) 10)
typedef uint8_t OBC_CUBEADCS_GEN2_AbstractImagingNodeType_t;
...
*/
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_COMMUNICATION_ERROR ((uint8_t) 0)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_ADCS_CONFIG_VALIDATION_ERROR ((uint8_t) 1)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_SETUP_ERROR ((uint8_t) 2)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_JUMP_ERROR ((uint8_t) 3)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_MAG_DEPLOY_ERROR ((uint8_t) 4)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_CONTROL_LOOP_FAILURE ((uint8_t) 5)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_NODE_FAILURE ((uint8_t) 6)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_CONFIG_PERSIST_ERROR ((uint8_t) 7)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_VIRTUAL_WATCHDOG_WARNING ((uint8_t) 8)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_PORT_VALIDATION_ERROR ((uint8_t) 9)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_AUTO_DISCOVERY_ERROR ((uint8_t) 10)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_CONTROL_LOOP_CRITICAL ((uint8_t) 11)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_GYRO_VOLTAGE_ERROR ((uint8_t) 12)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_GYRO_CRITICAL ((uint8_t) 13)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_VIRTUAL_WATCHDOG_ERROR ((uint8_t) 14)
#define OBC_CUBEADCS_GEN2_EVENTS_ENUM_MAX_CNT  ((uint8_t) 15)
...
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_REQUEST_FDIR ((uint8_t) 4)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_REQUEST_STATE_CHANGE ((uint8_t) 5)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_CHECK_COMPLETED ((uint8_t) 6)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_EVENT_DOWNLOAD_COMPLETED ((uint8_t) 8)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_STATE_CHANGE_COMPLETED ((uint8_t) 9)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_FDIR_COMPLETED ((uint8_t) 10)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_ADCS_RESETED ((uint8_t) 11)
#define OBC_CUBEADCS_GEN2_STATEMACHINEEVENTS_MAX_CNT  ((uint8_t) 12)
...
*/
typedef int32_t OBC_CUBEADCS_GEN2_AdcsErrorCode_t;
...
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_INIT ((uint8_t) 1)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_FIRMWARE_UPDATE ((uint8_t) 2)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_EVENT_MARKER_ACQUISITION ((uint8_t) 3)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_IDLE ((uint8_t) 4)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_CHECK ((uint8_t) 5)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_EVENT_DOWNLOAD ((uint8_t) 6)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_STATE_CHANGE ((uint8_t) 7)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_FDIR ((uint8_t) 8)
#define OBC_CUBEADCS_GEN2_STATEMACHINESTATES_MAX_CNT  ((uint8_t) 9)
...
#define OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_FMC_TARGET ((uint8_t) 25)
#define OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_YAW_SUN_SPIN ((uint8_t) 26)
#define OBC_CUBEADCS_GEN2_CONTROLMODES_CNTRL_SUN_DETUMBLE ((uint8_t) 27)
...
typedef struct {
    ...
    OBC_CUBEADCS_GEN2_NodePowerState_t eExtGyro0;
    OBC_CUBEADCS_GEN2_NodePowerState_t eExtGyro1;
...
*/
typedef struct {
    OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr_code;
    bool bForce;
...
typedef struct {
    OBC_CUBEADCS_GEN2_FName_t sFile_name;
    OBC_CUBEADCS_GEN2_AbstractImagingNodeType_t eNode;
    uint32_t u32File_handle;
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_directRequestData_t;
...
typedef struct {
    OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr;
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_directResponseData_t;

typedef struct {
    OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr;
    OBC_CUBEADCS_GEN2_FName_t sFile_name;
    OBC_CUBEADCS_GEN2_TctlmCubeComputerCommon3_ImageTransferStatus_t sStatus;
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_direct_statusResponseData_t;

typedef struct {
    uint32_t u32Errors;
    OBC_CUBEADCS_GEN2_StandardResult_t eOp_result;
} PACKED_STRUCT OBC_CUBEADCS_GEN2get_fdir_persistent_errorsResponseData_t;

typedef struct {
    OBC_CUBEADCS_GEN2_StandardResult_t eOp_result;
} PACKED_STRUCT OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsResponseData_t;
...
#endif  // #ifndef FP_OBC_CUBEADCS_GEN2PROTOCOLTYPES_H
