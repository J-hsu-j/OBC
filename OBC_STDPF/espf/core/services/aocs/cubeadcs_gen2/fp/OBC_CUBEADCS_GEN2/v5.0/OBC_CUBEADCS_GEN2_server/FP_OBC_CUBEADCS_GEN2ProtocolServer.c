...
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_directProtocolRequestData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
    OBC_CUBEADCS_GEN2download_img_directResponseData_t data;
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_directProtocolResponseData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_direct_statusProtocolRequestData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
    OBC_CUBEADCS_GEN2download_img_direct_statusResponseData_t data;
} PACKED_STRUCT OBC_CUBEADCS_GEN2download_img_direct_statusProtocolResponseData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
} PACKED_STRUCT OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolRequestData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
    OBC_CUBEADCS_GEN2get_fdir_persistent_errorsResponseData_t data;
} PACKED_STRUCT OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolResponseData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
} PACKED_STRUCT OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolRequestData_t;

typedef struct {
    ESSA_Stack_FP_MsgHdr_t hdr;
    OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsResponseData_t data;
} PACKED_STRUCT OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolResponseData_t;
...
static void fs_download_img_directReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo);
static void fs_download_img_direct_statusReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo);
static void fs_get_fdir_persistent_errorsReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo);
static void fs_clear_fdir_persistent_errorsReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo);
...
static const ProtocolFuncArrayEntry_t fs_aFuncArray[] = {
    ...
    { OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_FUNC_ID, fs_download_img_directReq },
    { OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_STATUS_FUNC_ID, fs_download_img_direct_statusReq },
    { OBC_CUBEADCS_GEN2_GET_FDIR_PERSISTENT_ERRORS_FUNC_ID, fs_get_fdir_persistent_errorsReq },
    { OBC_CUBEADCS_GEN2_CLEAR_FDIR_PERSISTENT_ERRORS_FUNC_ID, fs_clear_fdir_persistent_errorsReq },
...
static void fs_download_img_directReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo)
{
    OBC_CUBEADCS_GEN2download_img_directProtocolRequestData_t *fullrequest = (OBC_CUBEADCS_GEN2download_img_directProtocolRequestData_t *) fp_DataInfo->pu8Data;
    OBC_CUBEADCS_GEN2download_img_directRequestData_t *requestPayload = NULL;
    ReqContext_t requestCtx;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2download_img_directProtocolRequestData_t);
...
#ifndef BIG_ENDIAN_PLATFORM
    requestPayload = (OBC_CUBEADCS_GEN2download_img_directRequestData_t *) &fullrequest->data;
#else   // #ifndef BIG_ENDIAN_PLATFORM
    // TBD: Deserialize response fields
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    if (pSrvApiHnd->OBC_CUBEADCS_GEN2_download_img_directRequestHandler != NULL)
    {
        requestCtx.nInterfaceNumber = fp_DataInfo->pMACContext->nInterfaceNumber;
        requestCtx.netType = fp_DataInfo->pMACContext->netType;
        requestCtx.nAddr = fp_DataInfo->pMACContext->nSourceAddr;
        ...
        pSrvApiHnd->OBC_CUBEADCS_GEN2_download_img_directRequestHandler(&requestCtx,
                                        requestPayload);
    }
}
...
static void fs_download_img_direct_statusReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo)
{
    OBC_CUBEADCS_GEN2download_img_direct_statusProtocolRequestData_t *fullrequest = (OBC_CUBEADCS_GEN2download_img_direct_statusProtocolRequestData_t *) fp_DataInfo->pu8Data;
    ReqContext_t requestCtx;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2download_img_direct_statusProtocolRequestData_t);
    ...
    if (pSrvApiHnd->OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandler != NULL)
    {
        requestCtx.nInterfaceNumber = fp_DataInfo->pMACContext->nInterfaceNumber;
        requestCtx.netType = fp_DataInfo->pMACContext->netType;
        requestCtx.nAddr = fp_DataInfo->pMACContext->nSourceAddr;
        ...
        pSrvApiHnd->OBC_CUBEADCS_GEN2_download_img_direct_statusRequestHandler(&requestCtx);
    }
}

static void fs_get_fdir_persistent_errorsReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo)
{
    OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolRequestData_t *fullrequest = (OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolRequestData_t *) fp_DataInfo->pu8Data;
    ReqContext_t requestCtx;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolRequestData_t);
    ...
    if (pSrvApiHnd->OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandler != NULL)
    {
        requestCtx.nInterfaceNumber = fp_DataInfo->pMACContext->nInterfaceNumber;
        requestCtx.netType = fp_DataInfo->pMACContext->netType;
        requestCtx.nAddr = fp_DataInfo->pMACContext->nSourceAddr;
        ...
        pSrvApiHnd->OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsRequestHandler(&requestCtx);
    }
}

static void fs_clear_fdir_persistent_errorsReq(ESSA_Stack_DataDispatchInfo_t *fp_DataInfo)
{
    OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolRequestData_t *fullrequest = (OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolRequestData_t *) fp_DataInfo->pu8Data;
    ReqContext_t requestCtx;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolRequestData_t);
    ...
    if (pSrvApiHnd->OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandler != NULL)
    {
        requestCtx.nInterfaceNumber = fp_DataInfo->pMACContext->nInterfaceNumber;
        requestCtx.netType = fp_DataInfo->pMACContext->netType;
        requestCtx.nAddr = fp_DataInfo->pMACContext->nSourceAddr;
        ...
        pSrvApiHnd->OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsRequestHandler(&requestCtx);
    }
}
...
ESSATMAC_ErrCodes OBC_CUBEADCS_GEN2_download_evtResp(
                RespContext_t* ctx,
                const OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr
)
{
#ifndef BIG_ENDIAN_PLATFORM
...
ESSATMAC_ErrCodes OBC_CUBEADCS_GEN2_download_img_directResp(
                RespContext_t* ctx,
                const OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr
)
{
#ifndef BIG_ENDIAN_PLATFORM
    OBC_CUBEADCS_GEN2download_img_directProtocolResponseData_t responseParams;
#else  // #ifndef BIG_ENDIAN_PLATFORM
    uint8_t responseParams[sizeof(OBC_CUBEADCS_GEN2download_img_directProtocolResponseData_t)] = { 0 };
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    ESSATMAC_ErrCodes sendResult = ESSATMAC_EC_NULL;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2download_img_directProtocolResponseData_t);
    ...
    if (ctx != NULL)
    {
        ...
        // RS485 wire protocol also uses LE byte order -> serialization of params is not needed
        responseParams.hdr.protoId = ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2;
        responseParams.hdr.funcId  = OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_FUNCRESP_ID;
        responseParams.hdr.seqId   = ctx->seqId;
        responseParams.hdr.errCode = ESSA_FP_ERRCODE_NOERROR;
        SET_RESPONSE(responseParams.hdr);
    ...
    // TBD: Serialize request fields
        ...
        sendResult = ESSA_Stack_SendFrameEx((ESSASNetInterface) ctx->nInterfaceNumber,
                                            ...
                                            (uint8_t *) responseParams,
#endif // #ifndef BIG_ENDIAN_PLATFORM
                                            sizeof(OBC_CUBEADCS_GEN2download_img_directProtocolResponseData_t),
                                            STACK_SENDFRAME_DEFAULT_PRIO,
                                            (ESSATMAC_DrvResult_Cbk_t) NULL,
                                            (uint32_t *) NULL);
    }
...
ESSATMAC_ErrCodes OBC_CUBEADCS_GEN2_download_img_direct_statusResp(
                RespContext_t* ctx,
                const OBC_CUBEADCS_GEN2_AdcsErrorCode_t tErr,
                const OBC_CUBEADCS_GEN2_FName_t * const sFile_name,
                const OBC_CUBEADCS_GEN2_TctlmCubeComputerCommon3_ImageTransferStatus_t * const sStatus
)
{
#ifndef BIG_ENDIAN_PLATFORM
    OBC_CUBEADCS_GEN2download_img_direct_statusProtocolResponseData_t responseParams;
#else  // #ifndef BIG_ENDIAN_PLATFORM
    uint8_t responseParams[sizeof(OBC_CUBEADCS_GEN2download_img_direct_statusProtocolResponseData_t)] = { 0 };
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    ESSATMAC_ErrCodes sendResult = ESSATMAC_EC_NULL;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2download_img_direct_statusProtocolResponseData_t);

    if ((ctx != NULL) && (sFile_name != NULL) && (sStatus != NULL))
    {
#ifndef BIG_ENDIAN_PLATFORM
        // fill message header
        // RS485 wire protocol also uses LE byte order -> serialization of params is not needed
        responseParams.hdr.protoId = ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2;
        responseParams.hdr.funcId  = OBC_CUBEADCS_GEN2_DOWNLOAD_IMG_DIRECT_STATUS_FUNCRESP_ID;
        responseParams.hdr.seqId   = ctx->seqId;
        responseParams.hdr.errCode = ESSA_FP_ERRCODE_NOERROR;
        SET_RESPONSE(responseParams.hdr);
        ...
        if (sFile_name != NULL)
        {
            responseParams.data.sFile_name = *(sFile_name);
        }
        else
        {
            (void) memset((void *) &responseParams.data.sFile_name,
                          0U,
                          sizeof(responseParams.data.sFile_name));
        }
        if (sStatus != NULL)
        {
            responseParams.data.sStatus = *(sStatus);
    ...
    // TBD: Serialize request fields
        ...
        sendResult = ESSA_Stack_SendFrameEx((ESSASNetInterface) ctx->nInterfaceNumber,
                                            ...
                                            (uint8_t *) responseParams,
#endif // #ifndef BIG_ENDIAN_PLATFORM
                                            sizeof(OBC_CUBEADCS_GEN2download_img_direct_statusProtocolResponseData_t),
                                            STACK_SENDFRAME_DEFAULT_PRIO,
                                            (ESSATMAC_DrvResult_Cbk_t) NULL,
                                            (uint32_t *) NULL);
    }
...
ESSATMAC_ErrCodes OBC_CUBEADCS_GEN2_get_fdir_persistent_errorsResp(
                RespContext_t* ctx,
...
{
#ifndef BIG_ENDIAN_PLATFORM
    OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolResponseData_t responseParams;
#else  // #ifndef BIG_ENDIAN_PLATFORM
    uint8_t responseParams[sizeof(OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolResponseData_t)] = { 0 };
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    ESSATMAC_ErrCodes sendResult = ESSATMAC_EC_NULL;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolResponseData_t);
    ...
    if (ctx != NULL)
    {
        ...
        // RS485 wire protocol also uses LE byte order -> serialization of params is not needed
        responseParams.hdr.protoId = ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2;
        responseParams.hdr.funcId  = OBC_CUBEADCS_GEN2_GET_FDIR_PERSISTENT_ERRORS_FUNCRESP_ID;
        responseParams.hdr.seqId   = ctx->seqId;
        responseParams.hdr.errCode = ESSA_FP_ERRCODE_NOERROR;
        SET_RESPONSE(responseParams.hdr);
    ...
    // TBD: Serialize request fields
        ...
        sendResult = ESSA_Stack_SendFrameEx((ESSASNetInterface) ctx->nInterfaceNumber,
                                            ...
                                            (uint8_t *) responseParams,
#endif // #ifndef BIG_ENDIAN_PLATFORM
                                            sizeof(OBC_CUBEADCS_GEN2get_fdir_persistent_errorsProtocolResponseData_t),
                                            STACK_SENDFRAME_DEFAULT_PRIO,
                                            (ESSATMAC_DrvResult_Cbk_t) NULL,
                                            (uint32_t *) NULL);
    }
...
ESSATMAC_ErrCodes OBC_CUBEADCS_GEN2_clear_fdir_persistent_errorsResp(
                RespContext_t* ctx,
                const OBC_CUBEADCS_GEN2_StandardResult_t eOp_result
)
{
#ifndef BIG_ENDIAN_PLATFORM
    OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolResponseData_t responseParams;
#else  // #ifndef BIG_ENDIAN_PLATFORM
    uint8_t responseParams[sizeof(OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolResponseData_t)] = { 0 };
#endif  // #ifndef BIG_ENDIAN_PLATFORM

    ESSATMAC_ErrCodes sendResult = ESSATMAC_EC_NULL;

    STATIC_ASSERT_SIZE_CHECK(OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolResponseData_t);
    ...
    if (ctx != NULL)
    {
        ...
        // RS485 wire protocol also uses LE byte order -> serialization of params is not needed
        responseParams.hdr.protoId = ES_SAT_FUNC_PROTOCOL_ID_OBC_CUBEADCS_GEN2;
        responseParams.hdr.funcId  = OBC_CUBEADCS_GEN2_CLEAR_FDIR_PERSISTENT_ERRORS_FUNCRESP_ID;
        responseParams.hdr.seqId   = ctx->seqId;
        responseParams.hdr.errCode = ESSA_FP_ERRCODE_NOERROR;
        SET_RESPONSE(responseParams.hdr);
    ...
    // TBD: Serialize request fields
        ...
        sendResult = ESSA_Stack_SendFrameEx((ESSASNetInterface) ctx->nInterfaceNumber,
                                            ...
                                            (uint8_t *) responseParams,
#endif // #ifndef BIG_ENDIAN_PLATFORM
                                            sizeof(OBC_CUBEADCS_GEN2clear_fdir_persistent_errorsProtocolResponseData_t),
                                            STACK_SENDFRAME_DEFAULT_PRIO,
                                            (ESSATMAC_DrvResult_Cbk_t) NULL,
                                            (uint32_t *) NULL);
    }
