...
STATIC const cubeadcs_gen2_control_mode_info_t control_modes_desc[CUBEADCS_GEN2_MAX_NUM_OF_CONTROL_MODES] = {
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_NONE,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_NO_CONTROL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_BDOT,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YSPIN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_BDOT_3,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_DETUMBLE,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_YSPIN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_ZSPIN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_ZSPIN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_DETUMB_AND_SPIN,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_GGBOOM,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_GG,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_GGSUN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_GG,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YWHEEL_INIT,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_Y_MOMENTUM,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YWHEEL,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_Y_MOMENTUM,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_XYZWHEEL,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SUN_TRACK,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_TGT_TRACK,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_TGT_STEER,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_GND_TRACK,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_IRC_TRACK,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_MOON_TRACK,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_SAT_TRACK,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_SUN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_TARGET,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_ROLL_SUN,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_ROLL_TARGET,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_YAW_TARGET_BEST,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_XYZ_WHEEL,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_STOP_RW,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_WHEEL_MANAGEMENET,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_HXYZ_RW,
     .control_group = CUBEADCS_GEN2_CONTROL_GROUP_WHEEL_MANAGEMENET,
     },
    {
     .control_mode  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_USER,
...
STATIC const cubeadcs_gen2_estimator_mode_info_t est_modes_desc[CUBEADCS_GEN2_MAX_NUM_OF_ESTIMATOR_MODES] = {
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_NONE,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_NO_EST,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_GYRO,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_GYRO,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_MAG_RKF,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_MAG,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_PITCH_RKF,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_MAG_PITCH,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_TRIAD,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_TRIAD,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_FULL_EKF,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_FULL_STATE,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_GYRO_EKF,
     .estimator_group = CUBEADCS_GEN2_EST_GROUP_GYRO_EKF,
     },
    {
     .estimator_type  = TYPES_CUBE_COMPUTER_CONTROL_PROGRAM_8__EST_USER,
...
STATIC bool    fs_cubeadcs_gen2_get_control_mode_info(const TypesCubeComputerControlProgram8_ConModeSelect control_mode, cubeadcs_gen2_control_group_t *const p_control_mode_group);
STATIC bool    fs_cubeadcs_gen2_get_estimator_mode_info(const TypesCubeComputerControlProgram8_EstModeSelect estimation_mode, cubeadcs_gen2_est_group_t *const p_estimation_mode_group);
...
bool cubeadcs_gen2_is_sys_state_combo_valid(const TypesCubeComputerControlProgram8_ConModeSelect control_mode, const TypesCubeComputerControlProgram8_EstModeSelect estimation_mode)
{
    bool is_valid = false;
