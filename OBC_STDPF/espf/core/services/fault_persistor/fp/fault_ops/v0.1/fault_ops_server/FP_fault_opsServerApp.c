...
typedef int (*bad_instruction_t)(void);
...
{
  .fault_ops_get_fault_infoRequestHandler = fault_ops_get_fault_infoRequestHandlerImpl,
  .fault_ops_read_fault_by_index_rawRequestHandler = fault_ops_read_fault_by_index_rawRequestHandlerImpl,
  .fault_ops_clear_all_faultsRequestHandler = fault_ops_clear_all_faultsRequestHandlerImpl,
  .fault_ops_simulate_faultRequestHandler = fault_ops_simulate_faultRequestHandlerImpl,
  .fault_ops_read_fault_by_indexRequestHandler = fault_ops_read_fault_by_indexRequestHandlerImpl
};
    ...
    if ((pReqCtx != NULL) && (pRequestData != NULL))
    {
        ...
        switch (pRequestData->eFault_type)
        {
            ...
            case FAULT_OPS_FAULTTYPE_MEM_FAULT:
            {
                ...
                // we get an MPU fault
                bad_instruction_t bad_instruction = (bad_instruction_t)0xE0000000U;
