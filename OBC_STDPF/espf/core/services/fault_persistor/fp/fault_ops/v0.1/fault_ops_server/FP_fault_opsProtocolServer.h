...
#ifndef FP_FAULT_OPSPROTOCOLSERVER_H
#define FP_FAULT_OPSPROTOCOLSERVER_H
...
typedef void (*pffault_ops_read_fault_by_index_rawRequestHandler_t)(ReqContext_t *ctx, const fault_opsread_fault_by_index_rawRequestData_t *pRequestData);
typedef void (*pffault_ops_clear_all_faultsRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pffault_ops_simulate_faultRequestHandler_t)(ReqContext_t *ctx, const fault_opssimulate_faultRequestData_t *pRequestData);
typedef void (*pffault_ops_read_fault_by_indexRequestHandler_t)(ReqContext_t *ctx, const fault_opsread_fault_by_indexRequestData_t *pRequestData);
...
#endif  // #ifndef FP_FAULT_OPSPROTOCOLSERVER_H
