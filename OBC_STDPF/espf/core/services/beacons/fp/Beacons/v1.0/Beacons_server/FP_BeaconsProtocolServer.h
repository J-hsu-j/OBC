...
#ifndef FP_BEACONSPROTOCOLSERVER_H
#define FP_BEACONSPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
#define Beacons_PROTOCOL_VERSION_MAJOR   ((uint8_t) 1)
#define Beacons_PROTOCOL_VERSION_MINOR   ((uint8_t) 0)
...
typedef void (*pfBeacons_setBeaconGeneralConfigRequestHandler_t)(ReqContext_t *ctx, const BeaconssetBeaconGeneralConfigRequestData_t *pRequestData);
typedef void (*pfBeacons_getBeaconPresetConfigRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfBeacons_setBeaconPresetConfigRequestHandler_t)(ReqContext_t *ctx, const BeaconssetBeaconPresetConfigRequestData_t *pRequestData);
typedef void (*pfBeacons_setActivePresetRequestHandler_t)(ReqContext_t *ctx, const BeaconssetActivePresetRequestData_t *pRequestData);
...
#endif  // #ifndef FP_BEACONSPROTOCOLSERVER_H
