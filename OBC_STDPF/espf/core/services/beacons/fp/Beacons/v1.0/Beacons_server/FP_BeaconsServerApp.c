...
********************************************************************************************
* @version           interface Beacons v1.0
*
...
{
  .Beacons_getBeaconGeneralConfigRequestHandler = Beacons_getBeaconGeneralConfigRequestHandlerImpl,
  .Beacons_setBeaconGeneralConfigRequestHandler = Beacons_setBeaconGeneralConfigRequestHandlerImpl,
  .Beacons_getBeaconPresetConfigRequestHandler = Beacons_getBeaconPresetConfigRequestHandlerImpl,
  .Beacons_setBeaconPresetConfigRequestHandler = Beacons_setBeaconPresetConfigRequestHandlerImpl,
  .Beacons_setActivePresetRequestHandler = Beacons_setActivePresetRequestHandlerImpl,
  .Beacons_getActivePresetRequestHandler = Beacons_getActivePresetRequestHandlerImpl,
  .Beacons_restoreActivePresetRequestHandler = Beacons_restoreActivePresetRequestHandlerImpl
};
...
static void Beacons_getBeaconPresetConfigRequestHandlerImpl(ReqContext_t* pReqCtx)
{
    ...
    uint16_t au16Beacon_preset_cfg[60];
            ...
            const BeaconssetBeaconPresetConfigRequestData_t* pRequestData)
{
    ...
    RespContext_t respCtx;
    BEACONS_StandardResult_t eRes;
    uint8_t au8Preset_error_slot_index[3];
