...
typedef struct
{
    ...
    uint16_t    rem_msg_bytes_to_send; /**< number of bytes remaining to send from the previous frame */
} partial_msg_data_t;
...
typedef struct
{
    ...
    uint16_t              last_sink_frame_id;                           /**< frame id generated by the sink adapter for the last send operation */
