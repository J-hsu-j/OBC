...
static inline uint16_t safe_decrease(const uint16_t num, const uint16_t decr_value)
{
...
void beacons_sm_on_entry_Init(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
void beacons_sm_on_entry_Started(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
void beacons_sm_on_exit_Started(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
void beacons_sm_on_entry_Beacon_Wait_Time(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
void beacons_sm_on_entry_Stopped(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
bool beacons_sm_guard_can_stop_operation(const uint16_t instance_id, const sState_t* const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
bool beacons_sm_guard_is_beacon_time_expired(const uint16_t instance_id, const sState_t* const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
    ...
    return (IS_TRUE(beacons_rt_context.send_timer.is_running)) &&
           (true == timer_is_elapsed(&beacons_rt_context.send_timer, beacons_rt_context.gen_cfg.bcn_tx_period));
...
bool beacons_sm_guard_all_beacons_transmitted(const uint16_t instance_id, const sState_t* const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
bool beacons_sm_guard_is_sink_timeout_expired(const uint16_t instance_id, const sState_t* const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
bool beacons_sm_guard_can_continue_transmission(const uint16_t instance_id, const sState_t* const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
    ...
    return (IS_TRUE(beacons_rt_context.more_messages_pending) &&
            ...
            (IS_TRUE(beacons_rt_context.inter_frame_timer.is_running) &&
             (true == timer_is_elapsed(&beacons_rt_context.inter_frame_timer, beacons_rt_context.gen_cfg.bcn_inter_frame_period))));
...
void beacons_sm_action_reload_config(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
    ...
    if ((IS_TRUE(beacons_rt_context.reload_config_timer.is_running)) &&
...
void beacons_sm_action_start_beacon_burst(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
    ...
    timer_start(&beacons_rt_context.send_timer);
    beacons_sm_action_send_beacon(instance_id, pSMRoot, pEvent);
...
void beacons_sm_action_reset_send_state(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
...
void beacons_sm_action_log_sink_timeout_error(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
    ...
    ES_TRACE_WARN("beacon frame confirmation timeout");
...
void beacons_sm_action_send_beacon(const uint16_t instance_id, const sState_t * const pSMRoot, const sHSM_EventType_t * const pEvent)
{
    (void) instance_id;
    (void) pSMRoot;
    (void) pEvent;
    ...
    uint8_t *p_frame_pos        = &beacons_rt_context.active_beacon_frame[0U];
    uint8_t *p_flags_pos        = &(((beacon_frame_hdr_t *)p_frame_pos)->flags);
    uint16_t rem_bytes_in_frame = BEACON_FRAME_SIZE_BYTES;

    // the specified UHF maximum beacon size shall be able to accommodate at least 1 byte of beacon data + all required headers
    static_assert(BEACON_FRAME_SIZE_BYTES > sizeof(beacon_frame_hdr_t) + sizeof(beacon_msg_hdr_t));
         ...
         beacon_slot_idx++)
    {
            ...
            (DC_DID_MAX != dc_data_idx))
        {
            ...
            BREAK_ASSERT(bcn_msg_size <= BEACON_MSG_MAX_SIZE_BYTES);

            if (bcn_msg_size > BEACON_MSG_MAX_SIZE_BYTES)
            {
                bcn_msg_size = BEACON_MSG_MAX_SIZE_BYTES;
            }
            ...
            {
                ((beacon_msg_hdr_t *)p_frame_pos)->data_len = (uint8_t)bcn_msg_size;
                ...
                *p_beacon_data_status_pos =
                ...
                rem_bytes_in_frame = safe_decrease(rem_bytes_in_frame, (uint16_t)bcn_msg_size);
                    ...
                    (rem_bytes_in_frame > sizeof(beacon_msg_hdr_t)))
                {
                    ...
                    *p_flags_pos = (*p_flags_pos) | FRAME_HDR_FLAGS_CONTINUATION;
                    ...
                    if (IS_FALSE(beacons_rt_context.partial_msg_info.is_continuation_frame))
                    {
                        ...
                        beacons_rt_context.partial_msg_info.rem_msg_bytes_to_send = (uint16_t)(bcn_msg_size - bytes_until_end_of_frame);

                        // jump over individual beacon message header
                        rem_bytes_in_frame = safe_decrease(rem_bytes_in_frame, sizeof(beacon_msg_hdr_t));
                        (void)rem_bytes_in_frame; // unused here but kept for reference during debugging
                        p_frame_pos += sizeof(beacon_msg_hdr_t);
                        ...
                        *p_beacon_data_status_pos =
                        ...
                        rem_bytes_in_frame = safe_decrease(rem_bytes_in_frame, (uint16_t) bytes_until_end_of_frame);
                    ...
                    else
                    {
                        ...
                        ((beacon_msg_hdr_t *)p_frame_pos)->data_len = (uint8_t)beacons_rt_context.partial_msg_info.rem_msg_bytes_to_send;
    ...
    BREAK_ASSERT(BEACON_FRAME_SIZE_BYTES >= rem_bytes_in_frame);

    bool bSendConfirmed = beacons_sink.send(&beacons_rt_context.active_beacon_frame[0U],
                                            (uint8_t) ((BEACON_FRAME_SIZE_BYTES >= rem_bytes_in_frame) ? (BEACON_FRAME_SIZE_BYTES - rem_bytes_in_frame) : 0U),
                                            &beacons_rt_context.last_sink_frame_id);

    if (true == bSendConfirmed)
    {
