...
*/
/**
 * @brief Init routine for the solar panel system module
 */
mod_op_status_id_t sp_init(sys_init_level_id_t level);

/**
 * @brief Run routine for the solar panel system module
 */
mod_op_status_id_t sp_run(void);

/**
 * @brief Stop routine for the solar panel system module
 */
mod_op_status_id_t sp_stop(void);

/**
 * @brief Deinig routine for the solar panel system module
 */
mod_op_status_id_t sp_deinit(sys_init_level_id_t level);

/**
 * @brief Solar panel request response received handler
 * @param p_resp_ctx Pointer to the response context
 * @param p_resp_data Pointer to the response data
 */
