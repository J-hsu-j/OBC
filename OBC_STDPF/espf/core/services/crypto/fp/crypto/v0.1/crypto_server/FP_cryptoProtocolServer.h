...
#ifndef FP_CRYPTOPROTOCOLSERVER_H
#define FP_CRYPTOPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
typedef void (*pfcrypto_update_key_storeRequestHandler_t)(ReqContext_t *ctx, const cryptoupdate_key_storeRequestData_t *pRequestData);
typedef void (*pfcrypto_perform_cipher_opRequestHandler_t)(ReqContext_t *ctx, const cryptoperform_cipher_opRequestData_t *pRequestData);
typedef void (*pfcrypto_get_cipher_op_statusRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfcrypto_abortRequestHandler_t)(ReqContext_t *ctx, const cryptoabortRequestData_t *pRequestData);
...
#endif  // #ifndef FP_CRYPTOPROTOCOLSERVER_H
