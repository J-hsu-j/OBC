...
{
  .crypto_update_key_storeRequestHandler = crypto_update_key_storeRequestHandlerImpl,
  .crypto_perform_cipher_opRequestHandler = crypto_perform_cipher_opRequestHandlerImpl,
  .crypto_get_cipher_op_statusRequestHandler = crypto_get_cipher_op_statusRequestHandlerImpl,
  .crypto_abortRequestHandler = crypto_abortRequestHandlerImpl
};
