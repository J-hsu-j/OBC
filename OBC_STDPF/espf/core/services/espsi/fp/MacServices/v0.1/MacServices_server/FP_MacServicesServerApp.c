...
{
  .MacServices_getMacBusTerminationSettingRequestHandler = MacServices_getMacBusTerminationSettingRequestHandlerImpl,
  .MacServices_setMacBusTerminationSettingRequestHandler = MacServices_setMacBusTerminationSettingRequestHandlerImpl,
  .MacServices_setMacAddressRequestHandler = MacServices_setMacAddressRequestHandlerImpl
};
