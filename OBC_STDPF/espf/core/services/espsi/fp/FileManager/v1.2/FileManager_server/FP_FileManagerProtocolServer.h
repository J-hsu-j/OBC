...
#ifndef FP_FILEMANAGERPROTOCOLSERVER_H
#define FP_FILEMANAGERPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
typedef void (*pfFileManager_fileOpenRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileOpenRequestData_t *pRequestData);
typedef void (*pfFileManager_fileCloseRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileCloseRequestData_t *pRequestData);
typedef void (*pfFileManager_fileReadRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileReadRequestData_t *pRequestData);
typedef void (*pfFileManager_fileWriteRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileWriteRequestData_t *pRequestData);
typedef void (*pfFileManager_RenameRequestHandler_t)(ReqContext_t *ctx, const FileManagerRenameRequestData_t *pRequestData);
typedef void (*pfFileManager_DeleteRequestHandler_t)(ReqContext_t *ctx, const FileManagerDeleteRequestData_t *pRequestData);
typedef void (*pfFileManager_fileGetSizeRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileGetSizeRequestData_t *pRequestData);
typedef void (*pfFileManager_fileGetCheckSumRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileGetCheckSumRequestData_t *pRequestData);
typedef void (*pfFileManager_fileGetOpenedHandlesCountRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pfFileManager_formatPartitionRequestHandler_t)(ReqContext_t *ctx, const FileManagerformatPartitionRequestData_t *pRequestData);
typedef void (*pfFileManager_fileDumpDirListToFileRequestHandler_t)(ReqContext_t *ctx, const FileManagerfileDumpDirListToFileRequestData_t *pRequestData);
...
typedef void (*pfFileManager_sdReinitRequestHandler_t)(ReqContext_t *ctx, const FileManagersdReinitRequestData_t *pRequestData);
typedef void (*pfFileManager_dirMakeRequestHandler_t)(ReqContext_t *ctx, const FileManagerdirMakeRequestData_t *pRequestData);
...
#endif  // #ifndef FP_FILEMANAGERPROTOCOLSERVER_H
