...
/**
 * @brief Registers the current thread as one to be notified when an event is triggered
 *
 * @retval true  Current thread successfully registered
 * @retval false Another thread has already been registered
 */
