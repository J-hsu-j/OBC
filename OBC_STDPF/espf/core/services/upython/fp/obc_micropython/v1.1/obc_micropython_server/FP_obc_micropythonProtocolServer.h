...
#ifndef FP_OBC_MICROPYTHONPROTOCOLSERVER_H
#define FP_OBC_MICROPYTHONPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
typedef void (*pfobc_micropython_RequestScriptExecutionRequestHandler_t)(ReqContext_t *ctx, const obc_micropythonRequestScriptExecutionRequestData_t *pRequestData);
typedef void (*pfobc_micropython_GetScriptExecStatusRequestHandler_t)(ReqContext_t *ctx, const obc_micropythonGetScriptExecStatusRequestData_t *pRequestData);
...
#endif  // #ifndef FP_OBC_MICROPYTHONPROTOCOLSERVER_H
