...
// UPY_HEAP_SIZE_KB comes from the CMakeLists.txt configuration of the OBC port or
// could be redefined by the top-level project configuration.
#define MICROPYTHON_HEAP_SIZE (UPY_HEAP_SIZE_KB * 1024)
...
#ifndef WINDOWS_BUILD
#define MICROPY_VFS_ES_FM_MNG (1)
