...
typedef enum
{
    ...
    TELEMETRY_SINK_ADAPTER_CMD_FLUSH,
 ...
 *
 */
typedef void (*p_telemetry_sink_adapter_cmd)(tlm_file_sink_rt_ctx_t *const p_tlm_filesink_rt_ctx, const telemetry_sink_adapter_cmd_t cmd);
