...
#ifndef FP_TIMEPROTOCOLSERVER_H
#define FP_TIMEPROTOCOLSERVER_H
 ...
 *
 **********************************************************************/
typedef void (*pftime_set_dateRequestHandler_t)(ReqContext_t *ctx, const timeset_dateRequestData_t *pRequestData);
typedef void (*pftime_get_dateRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pftime_set_timeRequestHandler_t)(ReqContext_t *ctx, const timeset_timeRequestData_t *pRequestData);
typedef void (*pftime_get_timeRequestHandler_t)(ReqContext_t *ctx);
typedef void (*pftime_enable_calibration_outputRequestHandler_t)(ReqContext_t *ctx, const timeenable_calibration_outputRequestData_t *pRequestData);
typedef void (*pftime_configure_rtc_calibration_parametersRequestHandler_t)(ReqContext_t *ctx, const timeconfigure_rtc_calibration_parametersRequestData_t *pRequestData);
...
#endif  // #ifndef FP_TIMEPROTOCOLSERVER_H
