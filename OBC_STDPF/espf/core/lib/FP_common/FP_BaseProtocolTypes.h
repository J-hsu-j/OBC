...
#ifndef FP_BASEPROTOCOLTYPES_H
#define FP_BASEPROTOCOLTYPES_H
...
// coming from fp_trace.c (this is temporary until macchiato code generation is update to work with the new libtrace interface)
...
#endif  // #ifndef FP_BASEPROTOCOLTYPES_H
