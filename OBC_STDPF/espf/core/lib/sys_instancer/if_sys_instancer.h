 ...
 * - `run()`: Start any threads or OS dependencies (and start task_mon monitoring)
 * - `stop()`: Pause any thread execution (and stop task_mon from monitoring)
...
***************************************************************************************************
*/
/** @brief List of module interfaces */
