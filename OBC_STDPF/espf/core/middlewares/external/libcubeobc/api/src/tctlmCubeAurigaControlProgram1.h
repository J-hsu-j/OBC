...
/**
 * @brief ID 69, Trigger Spacewire Test
 ...
 * @return ErrorCode ERROR_OK on success
 */
ErrorCode tctlmCubeAurigaControlProgram1_setSpwTest(TypeDef_TctlmEndpoint *endpoint, TypesCubeAurigaControlProgram1_SpwTest *setVal);
...
/**
 * @brief ID 184, Spacewire Test Result
 ...
 * @return ErrorCode TCTLM__ERROR_OK on success
 */
ErrorCode tctlmCubeAurigaControlProgram1_getSpwTestResult(TypeDef_TctlmEndpoint *endpoint, TypesCubeAurigaControlProgram1_SpwTestResult *returnVal);
