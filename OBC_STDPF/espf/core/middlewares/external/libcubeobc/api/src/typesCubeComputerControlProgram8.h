...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_ConfigAdcsSatelliteStruct {
    F32 ixx;                 /**< Moment of inertia Ixx  (measurment unit is [kg.m^2]. valid range is between 0 kg.m^2 and 10000 kg.m^2) */
    F32 iyy;                 /**< Moment of inertia Iyy  (measurment unit is [kg.m^2]. valid range is between 0 kg.m^2 and 10000 kg.m^2) */
    F32 izz;                 /**< Moment of inertia Izz  (measurment unit is [kg.m^2]. valid range is between 0 kg.m^2 and 10000 kg.m^2) */
    F32 ixy;                 /**< Product of inertia Ixy  (measurment unit is [kg.m^2]. valid range is between -1000 kg.m^2 and 1000 kg.m^2) */
    F32 ixz;                 /**< Product of inertia Ixz  (measurment unit is [kg.m^2]. valid range is between -1000 kg.m^2 and 1000 kg.m^2) */
    F32 iyz;                 /**< Product of inertia Iyz  (measurment unit is [kg.m^2]. valid range is between -1000 kg.m^2 and 1000 kg.m^2) */
...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_TlmGnssRawStruct {
    ...
    F32 gnssSatPosEcefX;        /**< Satellite ECEF position vector X component  (measurment unit is [m]. valid range is between -50000000 m and 50000000 m) */
    F32 gnssSatPosEcefY;        /**< Satellite ECEF position vector Y component  (measurment unit is [m]. valid range is between -50000000 m and 50000000 m) */
    F32 gnssSatPosEcefZ;        /**< Satellite ECEF position vector Z component  (measurment unit is [m]. valid range is between -50000000 m and 50000000 m) */
    F32 gnssSatVelEcefX;        /**< Satellite ECEF velocity vector X component  (measurment unit is [m/s]. valid range is between -10000 m/s and 10000 m/s) */
    F32 gnssSatVelEcefY;        /**< Satellite ECEF velocity vector Y component  (measurment unit is [m/s]. valid range is between -10000 m/s and 10000 m/s) */
    F32 gnssSatVelEcefZ;        /**< Satellite ECEF velocity vector Z component  (measurment unit is [m/s]. valid range is between -10000 m/s and 10000 m/s) */
...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_TlmExtSensorRawStruct {
    U32 timeSeconds;              /**< Unix time integer seconds  (measurment unit is [s]) */
    U32 timeNs;                   /**< Unix time fraction nanoseconds  (measurment unit is [ns]) */
    F32 extSensor0Float0;         /**< ExtSensor0 raw float 0  (valid range is between -1000  and 1000 ) */
    F32 extSensor0Float1;         /**< ExtSensor0 raw float 1  (valid range is between -1000  and 1000 ) */
    F32 extSensor0Float2;         /**< ExtSensor0 raw float 2  (valid range is between -1000  and 1000 ) */
    F32 extSensor0Float3;         /**< ExtSensor0 raw float 3  (valid range is between -1000  and 1000 ) */
    F32 extSensor0Float4;         /**< ExtSensor0 raw float 4  (valid range is between -1000  and 1000 ) */
    F32 extSensor0Float5;         /**< ExtSensor0 raw float 5  (valid range is between -1000  and 1000 ) */
    F32 extSensor1Float0;         /**< ExtSensor1 raw float 0  (valid range is between -1000  and 1000 ) */
    F32 extSensor1Float1;         /**< ExtSensor1 raw float 1  (valid range is between -1000  and 1000 ) */
    F32 extSensor1Float2;         /**< ExtSensor1 raw float 2  (valid range is between -1000  and 1000 ) */
    F32 extSensor1Float3;         /**< ExtSensor1 raw float 3  (valid range is between -1000  and 1000 ) */
    F32 extSensor1Float4;         /**< ExtSensor1 raw float 4  (valid range is between -1000  and 1000 ) */
    F32 extSensor1Float5;         /**< ExtSensor1 raw float 5  (valid range is between -1000  and 1000 ) */
...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_TlmStrCubeAurigaRawStruct {
    ...
    F32 str0WRsFil1;                                             /**< Filtered angular rate1 in Rs  (measurment unit is [rad/s]. valid range is between -2 rad/s and 2 rad/s) */
    F32 str0WRsFil2;                                             /**< Filtered angular rate2 in Rs  (measurment unit is [rad/s]. valid range is between -2 rad/s and 2 rad/s) */
    ...
    F32 str1WRsFil1;                                             /**< Filtered angular rate1 in Rs  (measurment unit is [rad/s]. valid range is between -2 rad/s and 2 rad/s) */
    F32 str1WRsFil2;                                             /**< Filtered angular rate2 in Rs  (measurment unit is [rad/s]. valid range is between -2 rad/s and 2 rad/s) */
...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_TlmControllerStruct {
    ...
    F32 tgtRefAlt;                                                   /**< Reference ground/GEO target altitude  (measurment unit is [km]. valid range is between -100 km and 50000 km) */
...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_TlmCubeComputerHealthStruct {
    ...
    U16 v5Sense;                    /**< 5V supply voltage  (measurment unit is [mV]. valid range is between 0 mV and 7000 mV) */
    U16 batteryVoltage;             /**< Battery voltage  (measurment unit is [mV]. valid range is between 0 mV and 41000 mV) */
...
typedef struct TCTLM_PACKED TypesCubeComputerControlProgram8_OpenLoopCommandHxyzRWStruct {
    F32 hx;    /**< X-momentum open-loop speed command  (measurment unit is [Nms]. valid range is between -10 Nms and 10 Nms) */
    F32 hy;    /**< Y-momentum open-loop speed command  (measurment unit is [Nms]. valid range is between -10 Nms and 10 Nms) */
    F32 hz;    /**< Z-momentum open-loop speed command  (measurment unit is [Nms]. valid range is between -10 Nms and 10 Nms) */
