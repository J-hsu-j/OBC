...
typedef struct TCTLM_PACKED TypesCubeStarControlProgram6_DetectionMetaDataStruct {
    ...
    F32 avgAdError;          /**< Average angular separation error  (measurment unit is [arcsec]. valid range is between 0 arcsec and 10000 arcsec) */
    F32 avgPredictError;     /**< Average pixel position error  (measurment unit is [px]. valid range is between 0 px and 100 px) */
