...
typedef enum TypesCubeAurigaControlProgram1_OhStateValEnum {
    ...
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_PHOTO = 10,          /**< Photo */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_SENSOR_TEST = 11,    /**< SensorTest */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_WAIT_ACQ = 12,       /**< WaitAcq */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_OFF_REQUEST = 16,    /**< Error State Off Request */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_WAIT_OFF = 17,       /**< Error State Wait Off */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_IRQ_ERR = 18,        /**< Error State IRQ */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_RAZ_ERR = 19,        /**< Error State RAZ */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_OFF_ERR = 20,        /**< Error State Off Error */
    TYPES_CUBE_AURIGA_CONTROL_PROGRAM_1__OH_STATE_TIMEOUT_ERR = 21,    /**< Error State Timeout */
...
typedef struct TCTLM_PACKED TypesCubeAurigaControlProgram1_AurigaAttitudeDataStruct {
    ...
    F32 wRsFil1;                                           /**< Filtered angular rate1 in Rs  (measurment unit is [rad/s]. valid range is between -2 rad/s and 2 rad/s) */
    F32 wRsFil2;                                           /**< Filtered angular rate2 in Rs  (measurment unit is [rad/s]. valid range is between -2 rad/s and 2 rad/s) */
...
/**
 * @brief Trigger Spacewire Test message structure
 * @details Perform loopback test with SpW interfaces
 */
typedef struct TCTLM_PACKED TypesCubeAurigaControlProgram1_SpwTestStruct {
    U32 magicNumber;    /**< Must be correct to trigger SRAM test  */
} TypesCubeAurigaControlProgram1_SpwTest;
...
/**
 * @brief Spacewire Test Result message structure
 * @details Result of Spacewire Test
 */
typedef struct TCTLM_PACKED TypesCubeAurigaControlProgram1_SpwTestResultStruct {
    Boolean testResult;                                       /**< Spacewire Test Result  */
    TypesCubeAurigaControlProgram1_TestStateVal testState;    /**< Spacewire Test State  */
} TypesCubeAurigaControlProgram1_SpwTestResult;
