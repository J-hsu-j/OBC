...
typedef enum TypesCubeWheelControlProgram3_ControlModeValEnum {
    ...
    TYPES_CUBE_WHEEL_CONTROL_PROGRAM_3__SPEED_CONTROLLER = 1,     /**< Speed controller mode */
    TYPES_CUBE_WHEEL_CONTROL_PROGRAM_3__TORQUE_CONTROLLER = 2,    /**< Torque controller mode */
...
/**
 * @brief Wheel Duty Cycle message structure
 * @details Motor commanded PWM control signal
 */
