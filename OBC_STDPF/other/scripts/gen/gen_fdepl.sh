...
$JAVAEXE -jar $JARNAME --gen-dc ../../../espf/config/datacache/deploy_dc.fdepl
...
echo Copy the DC python interface to other/tests/fp_api...
cp -v src-gen-py/data_cache/*/*/data_cacheClientApp.py ../../tests/fp_api
